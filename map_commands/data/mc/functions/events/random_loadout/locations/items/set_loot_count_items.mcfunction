...
# Loot (Boost)
  ...
  # execute if score gearCount ItemsExpedition matches 1..3 run function mc:events/random_loadout/house/items/get_percentage
  ...
  execute if score characterSent ChestMenuExplore matches 5 run function mc:events/random_loadout/house/items/get_percentage
  ...
  execute if score isFatigued ItemsExpedition matches 1 run function mc:events/random_loadout/house/items/get_percentage
