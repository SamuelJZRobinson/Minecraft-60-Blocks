...
# Tag Items For Each Room
  ...
  execute if score room ItemsHouse matches 1 run teleport @s @e[type=minecraft:marker,limit=1,sort=random,tag=bathroom,tag=ground]
  ...
  execute if score room ItemsHouse matches 2 run teleport @s @e[type=minecraft:marker,limit=1,sort=random,tag=hallway,tag=ground]
  ...
  execute if score room ItemsHouse matches 3 run teleport @s @e[type=minecraft:marker,limit=1,sort=random,tag=kidsBedroom,tag=ground]
  ...
  execute if score room ItemsHouse matches 4 run teleport @s @e[type=minecraft:marker,limit=1,sort=random,tag=kitchen,tag=ground]
  ...
  execute if score room ItemsHouse matches 5 run teleport @s @e[type=minecraft:marker,limit=1,sort=random,tag=lounge,tag=ground]
  ...
  execute if score room ItemsHouse matches 6 run teleport @s @e[type=minecraft:marker,limit=1,sort=random,tag=masterBedroom,tag=ground]
  ...
  execute if score room ItemsHouse matches 7 run teleport @s @e[type=minecraft:marker,limit=1,sort=random,tag=sideBathroom,tag=ground]
...
# Call Root
execute if score itemCount ItemsHouse matches 0 run function mc:events/random_loadout/house/items/refresh_scores
