# CHEST OPENING
scoreboard objectives add OpenChestMenu minecraft.custom:minecraft.open_chest {"bold":true,"color":"white","text":"OpenChestMenu"}
scoreboard players reset * OpenChestMenu

# MAIN
scoreboard objectives add ChestMenuMain dummy {"bold":true,"color":"white","text":"ChestMenuMain"}
...
# EVENTS
scoreboard objectives add ChestMenuEvent dummy {"bold":true,"color":"white","text":"ChestMenuEvent"}
...
# FEEDING
  scoreboard objectives add ChestMenuFeed dummy {"bold":true,"color":"white","text":"ChestMenuFeed"}
  # Dolores
...
# EXPEDITION
  # MENU
    scoreboard objectives add ChestMenuExplore dummy {"bold":true,"color":"white","text":"ChestMenuExplore"}
    # Alerts
  ...
  # ITEMS
    scoreboard objectives add ItemsExpedition dummy {"bold":true,"color":"white","text":"ItemsExpedition"}
