...
# Extra Info
  ...
  # Highscore
  data merge block 20 132 -3 {Color:"light_blue",GlowingText:1b,Text1:'{"text":"Highscores","bold":true,"clickEvent":{"action":"run_command","value":"function mc:events/sounds/menu_click"}}',Text4:'{"text":"Click to view","color":"dark_blue","underlined":true,"clickEvent":{"action":"run_command","value":"function mc:states/stages/2_lobby/show/show_highscores"}}'}
  # Ideal Settings
  data merge block 20 131 -3 {Color:"light_blue",GlowingText:1b,Text1:'{"text":"Ideal Settings","bold":true,"clickEvent":{"action":"run_command","value":"function mc:events/sounds/menu_click"}}',Text4:'{"text":"Click to view","color":"dark_blue","underlined":true,"clickEvent":{"action":"run_command","value":"function mc:states/stages/2_lobby/show/show_settings"}}'}
  # Resource Pack
  data merge block 22 131 -3 {Color:"light_blue",GlowingText:1b,Text1:'{"text":"Resource Pack","bold":true,"clickEvent":{"action":"run_command","value":"function mc:events/sounds/menu_click"}}',Text4:'{"text":"Click to download","color":"dark_blue","underlined":true,"clickEvent":{"action":"run_command","value":"function mc:states/stages/2_lobby/show/show_resource_pack_url"}}'}
  # Game Creator
  data merge block 20 132 -8 {Color:"light_blue",GlowingText:1b,Text1:'{"text":"Game Creator","bold":true,"clickEvent":{"action":"run_command","value":"function mc:events/sounds/menu_click"}}',Text2:'{"text":"Robot Gentleman","clickEvent":{"action":"run_command","value":"function mc:states/stages/2_lobby/show/show_store_url"}}',Text4:'{"text":"Click to visit","underlined":true,"color":"dark_blue"}'}
  # Credits
  data merge block 22 132 -8 {Color:"light_blue",GlowingText:1b,Text1:'{"text":"Map Creator","bold":true,"clickEvent":{"action":"run_command","value":"function mc:events/sounds/menu_click"}}',Text2:'{"text":"BlackeyeI"}',Text4:'{"text":"Click for credits","color":"dark_blue","underlined":true,"clickEvent":{"action":"run_command","value":"function mc:states/stages/2_lobby/show/show_credits"}}'}