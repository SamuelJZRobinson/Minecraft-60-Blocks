...
execute if score gameMode Settings matches 2 run function mc:sounds/menu_click_error
...
execute if score gameMode Settings matches 4 run function mc:sounds/menu_click_error
