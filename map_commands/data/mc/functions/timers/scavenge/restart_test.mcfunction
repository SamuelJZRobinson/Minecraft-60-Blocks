...
execute unless score gameMode Lobby matches 1 unless score clock Timer matches 1..2 if score clock Timer matches 0..4 run function mc:sounds/menu_click_error
execute if score gameMode Lobby matches 1 run tellraw @s {"text":"Cannot restart scavenge.","color":"red"}
execute if score gameMode Lobby matches 1 run function mc:sounds/menu_click_error