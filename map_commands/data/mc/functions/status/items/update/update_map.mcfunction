...
execute if score map ItemsBunker matches 1 unless entity @e[x=-3,y=54,z=29,dx=6,dy=4,dz=6,type=minecraft:item_frame,tag=mapBreak] run function mc:status/items/spawn/spawn_map
