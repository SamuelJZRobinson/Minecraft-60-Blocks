...
# Fatigue
  ...
  execute if score fatigued TimmyStatus matches 0 if score day GameStatus >= FATIGUE_MIN StatusLevels if score day GameStatus <= FATIGUE_MAX StatusLevels run function mc:events/random_loadout/house/items/get_percentage
...
# Injuries
  ...
  execute if score alive TimmyStatus matches 1 if score sick TimmyStatus matches 0 if score infection TimmyStatus <= INFECTION_MIN StatusLevels run function mc:events/random_loadout/house/items/get_percentage
...
# Crazy
  ...
  execute if score alive TimmyStatus matches 1 if score crazy TimmyStatus matches 0 if score sanity TimmyStatus = SANITY_MIN StatusLevels run function mc:events/random_loadout/house/items/get_percentage
...
# Mental Breakdown
  ...
  execute if score alive TimmyStatus matches 1 if score crazyRage TimmyStatus matches 0 if score breakdown TimmyStatus <= BREAKDOWN_RAGE_MAX StatusLevels if score breakdown TimmyStatus > BREAKDOWN_MIN StatusLevels run function mc:events/random_loadout/house/items/get_percentage
  ...
  execute if score alive TimmyStatus matches 1 if score breakdown TimmyStatus <= BREAKDOWN_MIN StatusLevels run function mc:events/random_loadout/house/items/get_percentage
...
# Sickness
  ...
  # Malnutrition Chance (1 in x, n+1)
    ...
    execute if score alive TimmyStatus matches 1 if score sick TimmyStatus matches 0 if score soup TimmyStatus > HUNGER_MIN StatusLevels if score water TimmyStatus <= THIRST_MIN StatusLevels run function mc:events/random_loadout/house/items/get_percentage
    # No Soup, Has Water
  ...
  execute if score alive TimmyStatus matches 1 if score sickness TimmyStatus <= SICKNESS_MIN StatusLevels run function mc:events/random_loadout/house/items/get_percentage
