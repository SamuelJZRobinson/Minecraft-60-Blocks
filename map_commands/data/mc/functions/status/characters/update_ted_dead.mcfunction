...
execute if score escaped TedStatus matches 0 run function mc:events/sounds/character_death
# Crazy
execute if score escaped TedStatus matches 1 run kill @s
execute if score escaped TedStatus matches 1 run function mc:events/sounds/bunker_door1
