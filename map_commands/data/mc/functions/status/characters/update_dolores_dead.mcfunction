...
execute if score escaped DoloresStatus matches 0 run function mc:events/sounds/character_death
# Crazy
execute if score escaped DoloresStatus matches 1 run kill @s
execute if score escaped DoloresStatus matches 1 run function mc:events/sounds/bunker_door1
