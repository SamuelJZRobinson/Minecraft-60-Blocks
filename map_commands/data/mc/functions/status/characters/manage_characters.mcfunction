...
execute if score alive DoloresStatus matches 1 unless score characterSent ChestMenuExplore matches 1 unless score task AtomicDrill matches 13 unless score task AtomicDrill matches 18.. run function mc:status/characters/update_dolores
execute if score alive MaryStatus matches 1 unless score characterSent ChestMenuExplore matches 2..3 unless score task AtomicDrill matches 13 unless score task AtomicDrill matches 18.. run schedule function mc:status/characters/update_mary_base 2t replace
execute if score alive TedStatus matches 1 unless score characterSent ChestMenuExplore matches 4 unless score task AtomicDrill matches 13 unless score task AtomicDrill matches 18.. run schedule function mc:status/characters/update_ted 4t replace
execute if score alive TimmyStatus matches 1 unless score characterSent ChestMenuExplore matches 5 unless score task AtomicDrill matches 13 unless score task AtomicDrill matches 18.. run schedule function mc:status/characters/update_timmy 6t replace
