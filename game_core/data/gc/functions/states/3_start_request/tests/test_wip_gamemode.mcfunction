...
execute if score gamemode Settings matches 2 run function gc:utility/exceptions/raise_warning
# Survival
...
execute if score gamemode Settings matches 4 run function gc:utility/exceptions/raise_warning