...
# Rotate Item
execute if score room ItemsHouse matches 1..2 run function gc:states/4_setup/items/raise/rotate_items
...
# Loop
execute if score soupLeft ItemsHouse matches 0 run function gc:states/4_setup/items/inc_step
