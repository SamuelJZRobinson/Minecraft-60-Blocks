...
execute store result score kitchenWaterItemsLeft ItemsHouse run function gc:utility/math/get_random_value_via_amount_score {"x":1,"score":remainder,"objective":ItemsHouse}
...
# Hallway
  ...
  execute store result score hallwayWaterItemsLeft ItemsHouse run function gc:utility/math/get_random_value_via_amount_score {"x":0,"score":remainder,"objective":ItemsHouse}
