...
# Set Base Item Count
function gc:states/4_setup/place/items/set/set_room_item_count_base
...
execute if score remainder ItemsHouse matches 1.. run function gc:states/4_setup/place/items/set/set_room_item_count_hallway
...
# Soup
function gc:states/4_setup/place/items/set/set_room_soup_count

# Water
function gc:states/4_setup/place/items/set/set_room_water_count
