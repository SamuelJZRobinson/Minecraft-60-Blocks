...
# Rotate Item
execute if score room ItemsHouse matches 1..4 run function gc:states/4_setup/place/items/raise/rotate_items
...
# Loop
execute if score waterLeft ItemsHouse matches 0 run function gc:states/4_setup/place/items/inc_step
