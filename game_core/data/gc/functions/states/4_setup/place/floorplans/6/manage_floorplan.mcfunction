...
# Props
execute unless entity @e[type=minecraft:item_frame,tag=deleteItemFrame] run summon item_frame 8.00 -28.50 7.50 {Facing:5b,Invulnerable:1b,Fixed:1b,Tags:["house","deleteItemFrame"],Item:{id:"minecraft:filled_map",Count:1b,tag:{map:4}}}
...
function gc:states/4_setup/place/floorplans/6/summon_markers
schedule function gc:states/4_setup/place/floorplans/6/tag_room_markers 1t replace