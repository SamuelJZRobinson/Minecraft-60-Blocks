...
#     # Bonous Bunker Stock
#       # Easy And Medium
#       execute if score difficulty Settings matches 1..2 run schedule function gc:utility/scavenge/load_bonous_items 0.2s

#     # Declare New Day
#     schedule function gc:states/8_bunker/manage_day 3s

#   # Set Music
#   scoreboard players set music GameStatus 3
#   function gc:utility/music/music_loop
