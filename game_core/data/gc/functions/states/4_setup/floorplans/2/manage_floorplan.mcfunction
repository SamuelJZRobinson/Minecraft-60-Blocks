...
# Props
execute unless entity @e[type=minecraft:item_frame,tag=deleteItemFrame] run summon item_frame 27.00 -28.50 -9.50 {Facing:5b,Invulnerable:1b,Fixed:1b,Tags:["house","deleteItemFrame"],Item:{id:"minecraft:filled_map",count:1,components:{"minecraft:map_id":4}}}
...
function gc:states/4_setup/floorplans/2/summon_markers
function gc:states/4_setup/floorplans/2/tag_room_markers