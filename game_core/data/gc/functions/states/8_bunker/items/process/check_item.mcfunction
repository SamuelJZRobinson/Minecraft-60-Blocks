...
execute if score isAddition ItemsBundles matches 1 if score doSpawn ItemsBundles matches 1 at @p[team=Player] run function gc:states/8_bunker/items/process/check_item_add_spawn
