...
# Get Item Ids (Addition)
  ...
  execute if score bundleCount ItemsBundles matches 1.. run function gc:states/8_bunker/items/process/get_items_scavenge
  # Suitcase
  execute store result score bundleCount ItemsBundles run data get storage minecraft:itemsprocess suitcaseGainedItemIds
  execute if score bundleCount ItemsBundles matches 1.. run function gc:states/8_bunker/items/process/get_items_suitcase
...
# Get Item Ids (Subtraction)
  ...
  execute if score bundleCount ItemsBundles matches 1.. run function gc:states/8_bunker/items/process/get_crazy_items_broken
  # Expedition
  ...
  execute if score bundleCount ItemsBundles matches 1.. run function gc:states/8_bunker/items/process/get_characters
