...
# Calculate Real Count
  # Soups
  execute if score soups ItemsBunker matches 0.. run function gc:states/8_bunker/items/count/count_soups
  # Waters
  execute if score waters ItemsBunker matches 0.. run function gc:states/8_bunker/items/count/count_waters
