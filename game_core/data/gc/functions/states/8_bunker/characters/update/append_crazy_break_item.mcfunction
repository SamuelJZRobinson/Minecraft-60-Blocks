...
execute if score randomItemCount ItemsBundles matches 2.. run function gc:states/8_bunker/characters/update/crazy_break_item_get_array_index with storage minecraft:math
