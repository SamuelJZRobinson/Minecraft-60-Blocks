...
# Playsound
$execute if score alive $(objective) matches -1 if score isCrazyEscaped DoloresStatus matches 0 run function gc:sounds/character_death
$execute if score alive $(objective) matches -1 if score isCrazyEscaped DoloresStatus matches 1 run function gc:sounds/bunker_door
