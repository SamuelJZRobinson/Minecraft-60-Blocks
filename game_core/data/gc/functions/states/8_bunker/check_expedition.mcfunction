...
execute if score expeditionDuration MenuExpedition matches 1.. if score adultsAlive CharactersCount matches 1 if score childrenAlive CharactersCount matches 0 run schedule function gc:states/8_bunker/manage_day 1s
