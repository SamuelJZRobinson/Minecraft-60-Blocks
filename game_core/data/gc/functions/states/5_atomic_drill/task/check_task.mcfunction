...
# Complete Tasks
  ...
  # Task 3 (Find Timmy)
  execute if score task AtomicDrill matches 3 if entity @p[team=Player,nbt={Inventory:[{tag:{itemId:22}}]}] run scoreboard players set step AtomicDrill 2
  
  # Task 4 (Find Soup In Bathtub)
  execute if score task AtomicDrill matches 4 if entity @p[team=Player,nbt={Inventory:[{tag:{itemId:15}}]}] run scoreboard players set step AtomicDrill 2
  
  # Task 5 (Find Water In Kitchen)
  execute if score task AtomicDrill matches 5 if entity @p[team=Player,nbt={Inventory:[{tag:{itemId:17}}]}] run scoreboard players set step AtomicDrill 2
  ...
  execute if score task AtomicDrill matches 7 if entity @p[team=Player,nbt={Inventory:[{tag:{itemId:14}}]}] run scoreboard players set step AtomicDrill 2
  
  # Task 8 (Find Gas Mask In Hallway)
  execute if score task AtomicDrill matches 8 if entity @p[team=Player,nbt={Inventory:[{tag:{itemId:8}}]}] run scoreboard players set step AtomicDrill 2
