# Set Dialogue
data modify storage minecraft:atomicdrill dialogue append value "Take a gas mask to avoid deadly fallout radiation."
# Place Gas Mask
execute positioned 25.50 -27.60 3.75 run function gc:states/4_setup/items/summon/summon_gas_mask
