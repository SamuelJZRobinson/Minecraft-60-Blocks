...
# Place Radio
execute positioned 16.30 -29.00 13.45 run function gc:states/4_setup/place/items/summon/summon_radio
execute as @e[type=minecraft:slime,tag=radio,limit=1] at @s run teleport @s ~ ~ ~ 90 0
function gc:states/4_setup/place/items/raise/sync_rotation
