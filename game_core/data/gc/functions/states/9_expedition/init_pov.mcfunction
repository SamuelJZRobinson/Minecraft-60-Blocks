...
# Effects
# execute as @p[team=Player] run function gc:states/9_expedition/place/player/effects/manage_effects
...
function gc:states/9_expedition/place/manage_expedition_pov