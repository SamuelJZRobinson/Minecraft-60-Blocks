...
execute if score doInPersonExpedition Settings matches 1 unless score expeditionDeath AtomicDrill matches 1.. run function gc:timer/expedition/get_player_inventory
scoreboard players set stage ItemsBundles 9
execute if score doInPersonExpedition Settings matches 1 unless score expeditionDeath AtomicDrill matches 1.. run function gc:states/8_bunker/items/process/bundles/check/check_main_add
