...
execute if score mapVisited MenuExpedition matches 5 run function gc:states/9_expedition/player/tp/tp_bowling_alley
execute if score mapVisited MenuExpedition matches 6 run function gc:states/9_expedition/player/tp/tp_hospital
execute if score mapVisited MenuExpedition matches 7 run function gc:states/9_expedition/player/tp/tp_metro
