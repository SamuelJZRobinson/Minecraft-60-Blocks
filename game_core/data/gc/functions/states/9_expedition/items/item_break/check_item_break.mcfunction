...
execute if score itemsTakenCount ItemsExpedition matches 1.. if score output Math matches 1 run function gc:states/9_expedition/items/item_break/check_item_break_success
