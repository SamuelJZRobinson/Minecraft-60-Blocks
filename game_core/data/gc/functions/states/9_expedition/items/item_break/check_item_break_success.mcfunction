...
# Get Random Item
  ...
  execute if score randomItemCount ItemsBundles matches 2.. run function gc:states/9_expedition/items/item_break/get_array_index with storage minecraft:math
