...
execute if score doInPersonExpedition Settings matches 1 if score step ItemsExpedition matches 6 at @p[team=Player] run function gc:states/8_bunker/items/process/manage_bundles
...
# POV Extra Steps
  # Mobs
  execute if score doInPersonExpedition Settings matches 1 if score step ItemsExpedition matches 7 run function gc:states/9_expedition/place/mobs/set/manage_enemy_count
  execute if score doInPersonExpedition Settings matches 1 if score step ItemsExpedition matches 8 run function gc:states/9_expedition/place/mobs/summon/manage_summon_mobs
  execute if score doInPersonExpedition Settings matches 1 if score step ItemsExpedition matches 9 run function gc:states/9_expedition/place/mobs/spread/manage_spread_mobs
  execute if score doInPersonExpedition Settings matches 1 if score step ItemsExpedition matches 10 run function gc:states/9_expedition/place/items/spread/manage_spread_items
  # Kits
  execute if score doInPersonExpedition Settings matches 1 if score step ItemsExpedition matches 11 as @p[team=Player] run function gc:states/9_expedition/place/items/kits/manage_give_kit
  # Start
  execute if score doInPersonExpedition Settings matches 1 if score step ItemsExpedition matches 12 run function gc:states/9_expedition/place/start_pov_expedition