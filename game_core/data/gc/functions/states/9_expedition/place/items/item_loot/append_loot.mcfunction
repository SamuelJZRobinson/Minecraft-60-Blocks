...
execute if score randomItemCount ItemsBundles matches 2.. run function gc:states/9_expedition/place/items/item_loot/get_array_index with storage minecraft:math
