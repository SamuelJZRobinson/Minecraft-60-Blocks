...
execute if score lootLeft ItemsExpedition matches ..6 store result score itemsLeft ItemsExpedition run random value 2..4
execute if score lootLeft ItemsExpedition matches ..8 store result score itemsLeft ItemsExpedition run random value 3..4
