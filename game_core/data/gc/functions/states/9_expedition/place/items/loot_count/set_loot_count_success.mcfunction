# Base Loot
function gc:states/9_expedition/place/items/loot_count/set_loot_count_base
...
# Item Count
function gc:states/9_expedition/place/items/loot_count/set_loot_count_items

# Food Count For Remainder
function gc:states/9_expedition/place/items/loot_count/set_loot_count_food
