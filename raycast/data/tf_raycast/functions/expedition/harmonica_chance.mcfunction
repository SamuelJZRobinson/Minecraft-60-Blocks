...
execute if score math_out em matches 1..2 as @e[team=Mobs,distance=..16] run effect give @s slowness 15 1 false
...
execute if score math_out em matches 3..5 as @e[team=Mobs,distance=..16] run effect give @s speed 15 1 false
