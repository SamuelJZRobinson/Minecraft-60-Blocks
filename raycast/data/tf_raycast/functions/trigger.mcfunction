...
# Open Item
execute at @s[nbt={SelectedItem:{tag:{ammo:1b}}}] run function mc:states/8_expedition/place/items/open/open_ammo
execute at @s[nbt={SelectedItem:{tag:{armour:1b}}}] run function mc:states/8_expedition/place/items/open/open_armour
execute at @s[nbt={SelectedItem:{tag:{medkit:1b}}}] anchored eyes run function mc:states/8_expedition/place/items/open/open_medkit
execute at @s[nbt={SelectedItem:{tag:{gasMask:1b}}}] run function mc:states/8_expedition/place/items/open/open_gas_mask