...
execute if score fakeBlindness GameStatus matches 1 run effect give @s blindness infinite 0 true
...
execute if score fakeBlindness GameStatus matches 2 as @p[team=Playing] run function mc:utility/outfit/manage_house_outfit
execute if score fakeBlindness GameStatus matches 2 run effect clear @s slowness
execute if score fakeBlindness GameStatus matches 2 run effect clear @s blindness
