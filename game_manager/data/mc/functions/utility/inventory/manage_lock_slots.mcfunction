...
# Lock Inventory
  # Setup
  execute if score gameState GameStatus matches 4 run function mc:utility/inventory/lock_inventory
  # Atomic Drill
  execute if score gameState GameStatus matches 5 run function mc:utility/inventory/lock_inventory
  # Grace Period
  execute if score gameState GameStatus matches 6 run function mc:utility/inventory/lock_inventory
  # Scavenge House
  execute if score gameState GameStatus matches 7 run function mc:utility/inventory/lock_inventory

# Lock Hotbar
  # Setup
  execute if score gameState GameStatus matches 4 run function mc:utility/inventory/lock_hotbar
  # Grace Period
  execute if score gameState GameStatus matches 6 run function mc:utility/inventory/lock_hotbar
  # Scavenge House
