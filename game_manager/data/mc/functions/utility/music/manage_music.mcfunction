...
execute if score music GameStatus matches 0 run schedule function mc:utility/music/manage_music 234s replace
...
execute if score music GameStatus matches 2 run schedule function mc:utility/music/manage_music 21s replace
...
execute if score music GameStatus matches 3 run schedule function mc:utility/music/manage_music 96s replace

execute if score music GameStatus matches 4 run playsound minecraft:music_disc.chirp record @a 0.5 54.5 30.0 1 1 1
execute if score music GameStatus matches 4 run schedule function mc:utility/music/manage_music 185s replace
