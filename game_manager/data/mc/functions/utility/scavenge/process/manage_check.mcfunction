...
execute if score stage CheckItems matches 1 run function mc:utility/scavenge/process/check_main_add
execute if score stage CheckItems matches 2 if score difficulty Settings matches 1..2 run function mc:utility/scavenge/process/load_bonous_items
...
execute if score stage CheckItems matches 4 run function mc:utility/scavenge/process/check_main_remove