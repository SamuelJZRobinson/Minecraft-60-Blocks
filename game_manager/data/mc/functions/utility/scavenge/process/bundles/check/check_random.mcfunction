...
execute if score stage CheckItems matches 2 if score itemsOwed CheckItems matches 0 run function mc:utility/scavenge/process/bundles/check/check_main_add
execute if score stage CheckItems matches 6 if score itemsOwed CheckItems matches 0 run function mc:utility/scavenge/process/bundles/check/check_main_add
execute if score stage CheckItems matches 4 if score itemsOwed CheckItems matches 0 run function mc:utility/scavenge/process/bundles/check/check_main_remove
execute if score stage CheckItems matches 7 if score itemsOwed CheckItems matches 0 run function mc:utility/scavenge/process/bundles/check/check_main_remove

# Loop
execute if score itemsOwed CheckItems matches 1.. run function mc:utility/scavenge/process/bundles/check/check_random