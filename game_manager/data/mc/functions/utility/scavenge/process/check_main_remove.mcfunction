...
# Append Bundle
execute if score stage CheckItems matches 4 run function mc:utility/scavenge/process/set_bundle_crazy_lost
execute if score stage CheckItems matches 5 run function mc:utility/scavenge/process/set_bundle_family_lost
execute if score stage CheckItems matches 7 run function mc:utility/scavenge/process/set_bundle_expedition_lost
...
execute if score itemsTotal CheckItems matches 1.. run function mc:utility/scavenge/process/check_main_remove