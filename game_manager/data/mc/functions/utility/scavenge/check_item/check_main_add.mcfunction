...
# Items
  ...
  execute if score stage CheckItems matches 1 run function mc:utility/scavenge/check_item/check_main_add_many
  execute if score stage CheckItems matches 2 run function mc:utility/scavenge/check_item/check_main_add_one
  execute if score stage CheckItems matches 6 run function mc:utility/scavenge/check_item/check_main_add_one
  execute if score stage CheckItems matches 8..9 run function mc:utility/scavenge/check_item/check_main_add_one

# Append Bundles
execute if score stage CheckItems matches 2 if score difficulty Settings matches 1..2 if score itemsTotal CheckItems matches ..5 run function mc:utility/scavenge/check_item/set_bundle_bonous
execute if score stage CheckItems matches 6 run function mc:utility/scavenge/check_item/set_bundle_expedition_loot
execute if score stage CheckItems matches 8..9 run function mc:utility/scavenge/check_item/set_bundle_expedition_loot
...
execute if score itemsTotal CheckItems matches 1.. run function mc:utility/scavenge/check_item/check_main_add
execute if score stage CheckItems matches 1 if score itemsTotal CheckItems matches 0 run function mc:utility/scavenge/check_item/check_valid
...
execute if score stage CheckItems matches 2 if score itemsTotal CheckItems matches 0 run function mc:utility/scavenge/check_item/manage_check
...
execute if score stage CheckItems matches 8 if score itemsTotal CheckItems matches 0 if score doPovExpedition Settings matches 0 run schedule function mc:utility/scavenge/check_item/set_bundle_details 1t replace
