...
execute unless score lockInventory GameStatus matches 3 as @p[team=Player,scores={OpenShulkerBox=1..}] run function mc:utility/scavenge/collect/inventory/open_salvage_crate