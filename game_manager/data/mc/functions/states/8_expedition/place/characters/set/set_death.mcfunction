...
function mc:states/8_expedition/place/characters/get/get_risk
...
# Death Chance (threshold in 100%, n+1)
  ...
  # Outcome
    # Dead
    execute unless score math_out em matches 0 if score math_out em <= memory em run function mc:states/8_expedition/place/characters/set/set_death_character
    # Alive
    ...
    execute unless score math_out em matches 0 if score math_out em > memory em run schedule function mc:states/8_expedition/place/manage_placement 1t replace