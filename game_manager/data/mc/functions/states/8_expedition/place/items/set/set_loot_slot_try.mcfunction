...
# Call Next
execute if score specialCount ItemsExpedition matches 0 run function mc:states/8_expedition/place/items/set/load_loot_slot_free
execute if score specialCount ItemsExpedition matches 0 run function mc:states/8_expedition/place/items/set/set_loot_slot

# Loop
execute if score specialCount ItemsExpedition matches 1.. run function mc:states/8_expedition/place/items/set/set_loot_slot_try