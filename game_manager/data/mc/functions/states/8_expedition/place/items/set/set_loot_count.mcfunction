# Loot (Base)
  # Short
  execute if score mapVisited MenuExplore matches 1..4 run function mc:utility/math/get_random_range {x:1,y:5}
  # Medium
  execute if score mapVisited MenuExplore matches 5..6 run function mc:utility/math/get_random_range {x:2,y:6}
  # Long
  execute if score mapVisited MenuExplore matches 7..8 run function mc:utility/math/get_random_range {x:3,y:7}
  # Copy Output
...
# Boost Loot
  ...
  # Timmy Skills
    ...
    # Calculate
    execute if score characterSent MenuExplore matches 5 run function mc:utility/math/get_random_range with storage minecraft:math
    # Test
...
# Nerf Loot
  # Fatigue
    ...
    # Calculate
    execute if score isFatigued ItemsExpedition matches 1 run function mc:utility/math/get_random_range with storage minecraft:math
    # Test
...
schedule function mc:states/8_expedition/place/manage_placement 1t replace