# No Loot Chance
  ...
  # Test
    ...
    execute if score out Math matches 1 run schedule function mc:states/8_expedition/place/manage_placement 1t replace
    # Have Items
    execute unless score out Math matches 1 run scoreboard players add stage ItemsExpedition 1
    execute unless score out Math matches 1 run schedule function mc:states/8_expedition/place/manage_placement 1t replace