# Auto
execute if score doPovExpedition Settings matches 0 if data storage minecraft:bundles expeditionGearId run function mc:states/8_expedition/place/items/set/set_gear_break
