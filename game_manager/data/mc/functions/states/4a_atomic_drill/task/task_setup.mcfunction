...
# Task 3 (Find Timmy)
  ...
  # Spawn Timmy
  execute if score task AtomicDrill matches 3 run function mc:states/4_setup_house/place/characters/spawn/spawn_timmy
...
# Task 4 (Find Soup In Bathtub)
  ...
  # Place Soup
  execute if score task AtomicDrill matches 4 positioned 22.40 64.00 6.45 run function mc:utility/scavenge/items/spawn/spawn_soup
...
# Task 5 (Find Water In Kitchen)
  ...
  # Place Water
  execute if score task AtomicDrill matches 5 positioned 27.50 65.00 -14.55 run function mc:utility/scavenge/items/spawn/spawn_water
...
# Task 6 (Salvage Items)
  ...
  execute if score task AtomicDrill matches 6 run function mc:states/4_setup_house/place/floorplans/spawn/spawn_bunker_indicator
...
# Task 7 (Find Radio In Living Room Shelf)
  ...
  # Place Radio
  execute if score task AtomicDrill matches 7 positioned 19.30 65.00 6.45 run function mc:utility/scavenge/items/spawn/spawn_radio
  ...
  execute if score task AtomicDrill matches 7 run function mc:states/4_setup_house/place/items/raise/sync_rotation
...
# Task 8 (Find Gas Mask In Hallway)
  ...
  # Place Gas Mask
  execute if score task AtomicDrill matches 8 positioned 28.50 66.50 -3.25 run function mc:utility/scavenge/items/spawn/spawn_gas_mask
  ...
  execute if score task AtomicDrill matches 8 run function mc:states/4_setup_house/place/items/raise/sync_rotation
...
# Task 9 (Salvage Items)
  ...
  # Create Marker
  execute if score task AtomicDrill matches 9 run function mc:states/4_setup_house/place/floorplans/spawn/spawn_bunker_indicator
...
# Task 14 (Feed Thirsty Characters And Event One, Day Three)
  # Force Thirst
  execute if score task AtomicDrill matches 14 run function mc:states/4a_atomic_drill/force_thirst
  # Give Journal
...
# Task 16 (Character Returns Injured, Day Five)
  ...
  execute if score task AtomicDrill matches 16 run function mc:states/4a_atomic_drill/force_expedition_return
...
# Task 21 (Final Words And Reset, Day Ten)
  ...
  # Break The Script
  execute if score task AtomicDrill matches 21 run schedule clear mc:states/4a_atomic_drill/task/task_loop

# Request Dialogue
execute unless score task AtomicDrill matches 13.. run function mc:states/4a_atomic_drill/show/show_dialogue_loop
