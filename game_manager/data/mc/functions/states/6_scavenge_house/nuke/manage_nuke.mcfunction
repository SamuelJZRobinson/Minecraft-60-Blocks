...
# Outcome
execute if score gamemode Settings matches 1 run function mc:states/6_scavenge_house/nuke/give_drill_items
execute if score nukeSurvived GameStatus matches 1 run function mc:states/6_scavenge_house/nuke/nuke_safe
execute if score nukeSurvived GameStatus matches 0 run function mc:states/6_scavenge_house/nuke/nuke_dead
