...
# Mental Breakdown
  ...
  execute if score crazyRage TimmyStatus matches 1 if score itemCount ItemsBunker matches 1.. run function mc:states/7_bunker/cosmetics/characters/set/set_crazy_timmy
  scoreboard players set math_out em 0
...
# Decorate Bunker
  # Spawn
  execute if score alive TimmyStatus matches 1 unless entity @e[type=minecraft:armor_stand,tag=bunkerTimmy] run function mc:states/7_bunker/cosmetics/characters/spawn/spawn_timmy
  ...
  # Update Death
  execute if score alive TimmyStatus matches 0 as @e[type=minecraft:armor_stand,tag=bunkerTimmy] run function mc:states/7_bunker/cosmetics/characters/update/update_timmy_dead