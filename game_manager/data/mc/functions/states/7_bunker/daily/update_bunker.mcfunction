...
execute if score day GameStatus matches 1..7 if score totalAlive GameStatus matches ..3 if score characterRevived GameStatus matches 0 run function mc:states/7_bunker/cosmetics/characters/update/revive

# Update
function mc:states/7_bunker/cosmetics/manage_cosmetics
