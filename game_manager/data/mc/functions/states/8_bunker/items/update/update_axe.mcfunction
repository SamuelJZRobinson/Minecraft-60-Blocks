...
execute if score axe ItemsBunker matches 2 if entity @s[tag=!setModel] run kill @e[type=minecraft:interaction,tag=hitboxAxe]
...
execute if score axe ItemsBunker matches -1 if entity @s[tag=setModel] run kill @e[type=minecraft:interaction,tag=hitboxAxe]
