...
# Append Bundles
# execute if score setBundle ItemsBundles matches 1 run function mc:states/8_bunker/items/process/set_bundle_bonous

# execute if score stage ItemsBundles matches 2 if score difficulty Settings matches 1..2 if score itemsLeft ItemsBundles matches ..5 run function mc:states/8_bunker/items/process/bundles/set_bundle_bonous
# execute if score stage ItemsBundles matches 6 run function mc:states/8_bunker/items/process/bundles/set_bundle_expedition_loot
# execute if score stage ItemsBundles matches 8..9 run function mc:states/8_bunker/items/process/bundles/set_bundle_expedition_loot
...
# Append Bundle
# execute if score stage ItemsBundles matches 4 run function mc:states/8_bunker/items/process/bundles/set_bundle_crazy_lost
# execute if score stage ItemsBundles matches 5 run function mc:states/8_bunker/items/process/bundles/set_bundle_family_lost
# execute if score stage ItemsBundles matches 7 run function mc:states/8_bunker/items/process/bundles/set_bundle_expedition_lost
...
# execute if score stage ItemsBundles matches 8 if score itemsLeft ItemsBundles matches 0 if score doPovExpedition Settings matches 0 run schedule function mc:states/8_bunker/items/process/bundles/set_bundle_details 1t replace
