...
# Label
summon armor_stand ~0.5 ~1.5 ~ {CustomNameVisible:0b,Team:Items,NoGravity:1b,Invulnerable:1b,Marker:1b,Invisible:1b,Tags:["bunkerStatus","map","bunkerTitle"],DisabledSlots:4144959,CustomName:'{"text":"Map"}'}