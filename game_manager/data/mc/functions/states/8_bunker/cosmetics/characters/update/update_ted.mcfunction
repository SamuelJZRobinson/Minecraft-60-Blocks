...
# Mental Breakdown
  ...
  execute if score crazyRage TedStatus matches 1 if score itemCount ItemsBunker matches 1.. run function mc:states/8_bunker/cosmetics/characters/set/set_crazy_ted
  scoreboard players set math_out em 0
...
# Decorate Bunker
  ...
  # Update Death
  execute if score alive TedStatus matches 0 as @e[type=minecraft:armor_stand,tag=bunkerTed] run function mc:states/8_bunker/cosmetics/characters/update/update_ted_dead