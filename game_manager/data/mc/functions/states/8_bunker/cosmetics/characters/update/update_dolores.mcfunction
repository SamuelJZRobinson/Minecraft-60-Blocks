...
# Mental Breakdown
  ...
  execute if score crazyRage DoloresStatus matches 1 if score itemCount ItemsBunker matches 1.. run function mc:states/8_bunker/cosmetics/characters/set/set_crazy_dolores
  scoreboard players set math_out em 0
...
# Decorate Bunker
  # Spawn
  execute if score alive DoloresStatus matches 1 unless entity @e[type=minecraft:armor_stand,tag=bunkerDolores] run function mc:states/8_bunker/cosmetics/characters/summon/summon_dolores
  ...
  # Update Death
  execute if score alive DoloresStatus matches 0 as @e[type=minecraft:armor_stand,tag=bunkerDolores] run function mc:states/8_bunker/cosmetics/characters/update/update_dolores_dead