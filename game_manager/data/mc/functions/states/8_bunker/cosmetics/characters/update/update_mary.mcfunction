...
execute if score mutated MaryStatus matches 1 as @e[type=minecraft:armor_stand,tag=bunkerMary,tag=!mutantChange] run function mc:states/8_bunker/cosmetics/characters/update/update_mary_mutated

# Call Normal Status Effects
execute if score mutated MaryStatus matches 0 run function mc:states/8_bunker/cosmetics/characters/update/update_mary_normal
