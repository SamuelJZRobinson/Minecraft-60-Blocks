...
# Mental Breakdown
  ...
  execute if score crazyRage MaryStatus matches 1 if score itemCount ItemsBunker matches 1.. run function mc:states/8_bunker/cosmetics/characters/set/set_crazy_mary
  scoreboard players set math_out em 0
