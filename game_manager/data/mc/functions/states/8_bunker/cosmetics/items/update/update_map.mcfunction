...
execute if score map ItemsBunker matches 1 unless entity @e[type=minecraft:item_frame,tag=mapBreak] run function mc:states/8_bunker/cosmetics/items/spawn/spawn_map
