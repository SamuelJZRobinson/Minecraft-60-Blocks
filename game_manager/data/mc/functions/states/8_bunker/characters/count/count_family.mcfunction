...
# Count Present
execute if score alive DoloresStatus matches 1 unless score characterSent MenuExpedition matches 1 run scoreboard players add totalPresent GameStatus 1
execute if score alive MaryStatus matches 1 unless score characterSent MenuExpedition matches 2..3 run scoreboard players add totalPresent GameStatus 1
execute if score alive TedStatus matches 1 unless score characterSent MenuExpedition matches 4 run scoreboard players add totalPresent GameStatus 1
execute if score alive TimmyStatus matches 1 unless score characterSent MenuExpedition matches 5 run scoreboard players add totalPresent GameStatus 1