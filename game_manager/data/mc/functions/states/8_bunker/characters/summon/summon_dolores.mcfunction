# Place Character
summon minecraft:armor_stand ~5 ~0.40 ~3 {NoGravity:1b,Invulnerable:1b,ShowArms:1b,NoBasePlate:1b,Tags:["dolores","bunkerHitbox","bunkerDolores"],Pose:{LeftArm:[-80f,45f,0f],RightArm:[-80f,-45f,0f],LeftLeg:[-90f,-45f,0f],RightLeg:[-90f,-28f,0f]},DisabledSlots:4144959,Rotation:[-315F,0F],ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:11543873}}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:13355975}}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:13550229}}},{id:"minecraft:saddle",Count:1b,tag:{CustomModelData:7}}]}
...
# Status
  ...
  summon armor_stand ~5 ~1.00 ~4 {CustomNameVisible:0b,NoGravity:1b,Invulnerable:1b,Marker:1b,Invisible:1b,Tags:["dolores","bunkerStatus","doloresStatus","doloresDehydration","bunkerTitle"],DisabledSlots:4144959,CustomName:'{"text":"Dehydration","color":"gold"}'}
  # Energy
  summon armor_stand ~5 ~0.75 ~4 {CustomNameVisible:0b,NoGravity:1b,Invulnerable:1b,Marker:1b,Invisible:1b,Tags:["dolores","bunkerStatus","doloresStatus","doloresTired","bunkerTitle"],DisabledSlots:4144959,CustomName:'{"text":"Tired","color":"gold"}'}