...
# Status
  ...
  # Energy
  summon armor_stand ~1 ~0.75 ~6 {CustomNameVisible:0b,NoGravity:1b,Invulnerable:1b,Marker:1b,Invisible:1b,Tags:["timmy","bunkerStatus","timmyStatus","timmyTired","bunkerTitle"],DisabledSlots:4144959,CustomName:'{"text":"Tired","color":"gold"}'}