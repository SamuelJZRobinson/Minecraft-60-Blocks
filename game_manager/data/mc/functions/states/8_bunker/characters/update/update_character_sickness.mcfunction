...
# Sickness Malnutrition Chance
  ...
  execute if score sick TedStatus matches 0 if score soup TedStatus <= HUNGER_MIN StatusLevels run function mc:utility/math/get_random_range with storage minecraft:math
  execute if score sick TedStatus matches 0 if score soup TedStatus <= HUNGER_MIN StatusLevels if score out Math matches 1 run scoreboard players set sick TedStatus 1
  ...
  execute if score sick TedStatus matches 0 if score water TedStatus <= THIRST_MIN StatusLevels run function mc:utility/math/get_random_range with storage minecraft:math
  execute if score sick TedStatus matches 0 if score water TedStatus <= THIRST_MIN StatusLevels if score out Math matches 1 run scoreboard players set sick TedStatus 1
