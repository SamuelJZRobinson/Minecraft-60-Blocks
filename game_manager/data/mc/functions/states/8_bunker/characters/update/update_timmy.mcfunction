...
# Mental Breakdown
  ...
  execute if score crazyRage TimmyStatus matches 1 if score itemCount ItemsBunker matches 1.. run function mc:states/8_bunker/characters/set/set_crazy_timmy
  scoreboard players set math_out em 0
