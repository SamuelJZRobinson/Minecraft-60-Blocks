...
execute if score alive TedStatus matches 1 unless score characterSent MenuExpedition matches 1 run function mc:states/8_bunker/characters/update/update_character
# Dolores
...
execute if score alive DoloresStatus matches 1 unless score characterSent MenuExpedition matches 2 run function mc:states/8_bunker/characters/update/update_character
# Mary
...
execute if score alive MaryStatus matches 1 unless score characterSent MenuExpedition matches 3 if score isMutant MaryStatus matches 0 run function mc:states/8_bunker/characters/update/update_character
execute if score isMutant MaryStatus matches 1 unless score characterSent MenuExpedition matches 3 if score isMutant MaryStatus matches 1 run function mc:states/8_bunker/characters/update/update_mary_mutated
# Timmy
...
execute if score alive TimmyStatus matches 1 unless score characterSent MenuExpedition matches 4 run function mc:states/8_bunker/characters/update/update_character