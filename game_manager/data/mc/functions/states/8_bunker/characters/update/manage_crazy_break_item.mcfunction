...
execute if score randomItemCount ItemsBundles matches ..0 run function mc:states/8_bunker/characters/update/append_crazy_break_item

# Break Item
execute if score randomItemCount ItemsBundles matches 1.. run function mc:states/8_bunker/characters/update/append_crazy_break_item