...
# Append Head
execute if score alive TedStatus matches -1 run data modify storage minecraft:itemsprocess charactersLostIds append value 19
execute if score alive DoloresStatus matches -1 run data modify storage minecraft:itemsprocess charactersLostIds append value 21
