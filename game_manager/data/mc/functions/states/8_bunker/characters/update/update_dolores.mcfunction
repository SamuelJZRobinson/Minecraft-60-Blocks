...
# Mental Breakdown
  ...
  execute if score crazyRage DoloresStatus matches 1 if score itemCount ItemsBunker matches 1.. run function mc:states/8_bunker/characters/set/set_crazy_dolores
  scoreboard players set math_out em 0
