...
execute if score isFatigued $(objective) matches 0 if score day GameStatus >= FATIGUE_DAYS_START StatusLevels if score day GameStatus <= FATIGUE_DAYS_END StatusLevels run function mc:utility/math/get_random_range with storage minecraft:math
