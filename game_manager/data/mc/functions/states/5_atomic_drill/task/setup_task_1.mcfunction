...
# Create Marker
execute positioned 22.50 -30.00 0.50 run function mc:states/5_atomic_drill/summon/summon_waypoint_cross
execute positioned 22.50 -28.00 0.50 run function mc:states/4_setup/place/floorplans/general/summon_waypoint_arrow
# Effects
