...
# Rotate Item
function mc:states/4_setup_house/place/items/raise/rotate_items
...
# Call Root
execute if score waterLeft ItemsHouse matches 0 run function mc:states/4_setup_house/place/items/refresh_scores
