...
schedule function mc:states/4_setup_house/place/floorplans/spawn/spawn_checkers_fp_4 1t replace
schedule function mc:states/4_setup_house/place/floorplans/tag/tag_fp_4 2t replace
