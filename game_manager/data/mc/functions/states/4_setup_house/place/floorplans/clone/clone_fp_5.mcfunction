...
# Props
execute unless entity @e[type=minecraft:item_frame,tag=calendar] run summon item_frame 28.00 65.50 3.50 {Facing:4b,Invulnerable:1b,Fixed:1b,Tags:["house","houseProp","calendar"],Item:{id:"minecraft:filled_map",Count:1b,tag:{map:4}}}
...
schedule function mc:states/4_setup_house/place/floorplans/spawn/spawn_checkers_fp_5 1t replace
schedule function mc:states/4_setup_house/place/floorplans/tag/tag_fp_5 2t replace
