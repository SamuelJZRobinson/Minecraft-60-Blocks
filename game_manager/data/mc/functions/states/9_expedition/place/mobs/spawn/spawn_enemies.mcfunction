# Load Tiers
  # One
  execute if score loadMob MobsExpedition matches 1 if score tierOne MobsExpedition matches 1.. positioned 0 60 30 run function mc:states/9_expedition/place/mobs/spawn/spawn_enemies_one
  ...
  # Two
  execute if score loadMob MobsExpedition matches 2 if score tierTwo MobsExpedition matches 1.. positioned 0 60 30 run function mc:states/9_expedition/place/mobs/spawn/spawn_enemies_two
  ...
  # Two (Bandits)
  execute if score loadMob MobsExpedition matches 3 if score tierTwoBandit MobsExpedition matches 1.. positioned 0 60 30 run function mc:states/9_expedition/place/mobs/spawn/spawn_enemies_two_bandit
  ...
  # Three
  execute if score loadMob MobsExpedition matches 4 if score tierThree MobsExpedition matches 1.. positioned 0 60 30 run function mc:states/9_expedition/place/mobs/spawn/spawn_enemies_three
...
# Loop
execute if score loadMob MobsExpedition matches 1..4 run function mc:states/9_expedition/place/mobs/spawn/spawn_enemies