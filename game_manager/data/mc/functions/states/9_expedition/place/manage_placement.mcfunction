...
# Standard
  # Characters
  execute if score stage ItemsExpedition matches 1 run function mc:states/9_expedition/place/characters/check/check_death
  # Gear
  execute if score stage ItemsExpedition matches 2 run function mc:states/9_expedition/place/items/check/check_gear_break
  # Loot
  execute if score stage ItemsExpedition matches 3 run function mc:states/9_expedition/place/items/check/check_loot_none
  execute if score stage ItemsExpedition matches 4 run function mc:states/9_expedition/place/items/set/set_loot_count
  execute if score stage ItemsExpedition matches 5 run function mc:states/9_expedition/place/items/set/set_loot_type
  execute if score stage ItemsExpedition matches 6 run function mc:states/9_expedition/place/items/set/set_loot_type_sustenance
# Extended POV
  # Mobs
