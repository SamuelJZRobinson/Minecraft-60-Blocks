# Give Items
execute if score hasAmmo ItemsExpedition matches 1 run function mc:states/9_expedition/place/items/kits/give_gun_ammo
execute if score hasBoyScoutHandbook ItemsExpedition matches 1 run function mc:states/9_expedition/place/items/kits/give_boyscout_handbook
execute if score hasBugSpray ItemsExpedition matches 1 run function mc:states/9_expedition/place/items/kits/give_bug_spray
execute if score hasCards ItemsExpedition matches 1 run function mc:states/9_expedition/place/items/kits/give_cards
...
execute if score hasSoup ItemsExpedition matches 1 run function mc:states/9_expedition/place/items/kits/give_soup
execute if score hasWater ItemsExpedition matches 1 run function mc:states/9_expedition/place/items/kits/give_water
execute if score hasAxe ItemsExpedition matches 1 run function mc:states/9_expedition/place/items/kits/give_axe
execute if score hasGun ItemsExpedition matches 1 run function mc:states/9_expedition/place/items/kits/give_gun
execute if score hasMedkit ItemsExpedition matches 1 run function mc:states/9_expedition/place/items/kits/give_medkit
execute if score hasSuitcase ItemsExpedition matches 1 run function mc:states/9_expedition/place/items/kits/give_suitcase
execute if score hasBodyArmour ItemsExpedition matches 1 run function mc:states/9_expedition/place/items/kits/give_body_armour
