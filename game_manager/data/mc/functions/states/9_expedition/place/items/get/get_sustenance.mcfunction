...
# Load Sustenance
  # Soup
  execute if score loadItem ItemsExpedition matches 1 if score soupCount ItemsExpedition matches 1.. run data modify storage minecraft:itemsprocess scavengeGainedItemIds append value 15
  ...
  # Water
  execute if score loadItem ItemsExpedition matches 2 if score waterCount ItemsExpedition matches 1.. run data modify storage minecraft:itemsprocess scavengeGainedItemIds append value 17
...
# Set Stage
execute if score loadItem ItemsExpedition matches 3 run scoreboard players add step ItemsExpedition 1
