# Update Subway Map
execute if score mapVisited MenuExpedition matches 7 as @p[team=Player,nbt={SelectedItem:{id:"minecraft:filled_map"}}] run function mc:states/9_expedition/place/items/update/update_items_metro_map
