# Character Health
execute if score step ItemsExpedition matches 1 run function mc:states/9_expedition/place/characters/death/manage_character_death
...
execute if score step ItemsExpedition matches 3 run function mc:states/9_expedition/place/items/item_loot/manage_loot
