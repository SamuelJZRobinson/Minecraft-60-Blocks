...
execute if score stage CheckItems matches 6 if score itemsTotal CheckItems matches 0 run function mc:states/9_expedition/place/items/get/get_slot_random
...
# execute if score stage CheckItems matches 8 if score itemsTotal CheckItems matches 0 if score doPovExpedition Settings matches 1 run schedule function mc:states/9_expedition/place/manage_placement 1t replace