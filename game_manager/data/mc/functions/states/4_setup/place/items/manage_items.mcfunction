...
# Set Room Item Count
execute if score step ItemsHouse matches 2 run function mc:states/4_setup/place/items/set/set_room_item_count
# Tag Items
...
execute if score step ItemsHouse matches 6 as @e[type=minecraft:slime,limit=1,team=Items,tag=unassigned] run function mc:states/4_setup/place/items/tag/tag_items_general
# Set Items
