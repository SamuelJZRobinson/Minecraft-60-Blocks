...
# Move Items
  # Bathroom
  execute if score room ItemsHouseHigh matches 1 as @e[type=minecraft:slime,limit=1,tag=bathroom,tag=!wallItem,tag=!raised] run function mc:states/4_setup/place/items/raise/raise_table_items_move
  # Hallway
  execute if score room ItemsHouseHigh matches 2 as @e[type=minecraft:slime,limit=1,tag=hallway,tag=!wallItem,tag=!raised] run function mc:states/4_setup/place/items/raise/raise_table_items_move
  # Kids Bedroom
  execute if score room ItemsHouseHigh matches 3 as @e[type=minecraft:slime,limit=1,tag=kidsBedroom,tag=!wallItem,tag=!raised] run function mc:states/4_setup/place/items/raise/raise_table_items_move
  # Kitchen
  execute if score room ItemsHouseHigh matches 4 as @e[type=minecraft:slime,limit=1,tag=kitchen,tag=!wallItem,tag=!raised] run function mc:states/4_setup/place/items/raise/raise_table_items_move
  # Lounge
  execute if score room ItemsHouseHigh matches 5 as @e[type=minecraft:slime,limit=1,tag=lounge,tag=!wallItem,tag=!raised] run function mc:states/4_setup/place/items/raise/raise_table_items_move
  # Master Bedroom
  execute if score room ItemsHouseHigh matches 6 as @e[type=minecraft:slime,limit=1,tag=masterBedroom,tag=!wallItem,tag=!raised] run function mc:states/4_setup/place/items/raise/raise_table_items_move
  # Side Bathroom
  execute if score room ItemsHouseHigh matches 7 as @e[type=minecraft:slime,limit=1,tag=sideBathroom,tag=!wallItem,tag=!raised] run function mc:states/4_setup/place/items/raise/raise_table_items_move
