...
# Props
execute unless entity @e[type=minecraft:item_frame,tag=prop] run summon item_frame 30.00 65.50 -16.50 {Facing:5b,Invulnerable:1b,Fixed:1b,Tags:["house","prop"],Item:{id:"minecraft:filled_map",Count:1b,tag:{map:4}}}
...
function mc:states/4_setup/place/floorplans/2/summon_room_markers
