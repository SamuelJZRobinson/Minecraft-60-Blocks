...
schedule function mc:states/4_setup/place/floorplans/spawn/spawn_checkers_fp_3 1t replace
schedule function mc:states/4_setup/place/floorplans/tag/tag_fp_3 2t replace
