...
# Props
execute unless entity @e[type=minecraft:item_frame,tag=prop] run summon item_frame 19.00 65.40 4.50 {Facing:4b,Invulnerable:1b,Fixed:1b,Tags:["house","prop"],Item:{id:"minecraft:filled_map",Count:1b,tag:{map:4}}}
