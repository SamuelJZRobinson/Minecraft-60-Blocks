...
summon minecraft:area_effect_cloud ~19 ~ ~ {Radius:0f,Duration:19999980,Tags:["floor","south"]}
summon minecraft:area_effect_cloud ~21 ~ ~ {Radius:0f,Duration:19999980,Tags:["floor","south"]}