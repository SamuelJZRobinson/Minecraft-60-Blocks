...
schedule function mc:states/4_setup/place/floorplans/spawn/spawn_checkers_fp_2 1t replace
schedule function mc:states/4_setup/place/floorplans/tag/tag_fp_2 2t replace
