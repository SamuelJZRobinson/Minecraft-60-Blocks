...
execute if score flashlight ItemsBunker matches 1 if entity @s[tag=!setModel] run summon area_effect_cloud 3.50 56.00 32.50 {Particle:"block air",Radius:0.125f,Duration:2147483647,Tags:["bunker","bunkerHitbox","bunkerFlashlight","hitboxFlashlight"]}
...
execute if score flashlight ItemsBunker matches -1 if entity @s[tag=setModel] run kill @e[type=minecraft:area_effect_cloud,tag=hitboxFlashlight]
execute if score flashlight ItemsBunker matches -1 if entity @s[tag=setModel] run summon area_effect_cloud 3.54 55.70 32.52 {Particle:"block air",Radius:0.3f,Duration:2147483647,Tags:["bunker","bunkerHitbox","bunkerFlashlight","hitboxFlashlight"]}
