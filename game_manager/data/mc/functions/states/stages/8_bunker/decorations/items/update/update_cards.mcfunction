...
execute if score cards ItemsBunker matches 1 if entity @s[tag=!setModel] run summon area_effect_cloud -0.66 54.76 30.42 {Particle:"block air",Radius:0.2f,Duration:2147483647,Tags:["bunker","bunkerHitbox","bunkerCards","hitboxCards"]}
execute if score cards ItemsBunker matches 1 if entity @s[tag=!setModel] run tag @s add setModel
execute if score cards ItemsBunker matches 0 run kill @e[tag=bunkerCards]
...
execute if score cards ItemsBunker matches -1 if entity @s[tag=setModel] run kill @e[type=minecraft:area_effect_cloud,tag=hitboxCards]
execute if score cards ItemsBunker matches -1 if entity @s[tag=setModel] run summon area_effect_cloud -0.55 54.58 30.48 {Particle:"block air",Radius:0.42f,Duration:2147483647,Tags:["bunker","bunkerHitbox","bunkerCards","hitboxCards"]}
