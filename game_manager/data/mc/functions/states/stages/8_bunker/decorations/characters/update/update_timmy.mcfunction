...
# Decorate Bunker
  # Spawn
  execute if score alive TimmyStatus matches 1 unless entity @e[x=2,y=54,z=29,dy=4,dz=1,type=minecraft:armor_stand,tag=bunkerTimmy] run function mc:states/stages/8_bunker/decorations/characters/spawn/spawn_timmy
  ...
  # Update Death
  execute if score alive TimmyStatus matches 0 as @e[x=2,y=54,z=29,dy=4,dz=1,type=minecraft:armor_stand,tag=bunkerTimmy] run function mc:states/stages/8_bunker/decorations/characters/update/update_timmy_dead