# Append Salvaged Items
  # Official
  execute if score ammo ItemsBunker matches 1 run data modify storage minecraft:checkitem randomId append value 1
  ...
  execute if score bugSpray ItemsBunker matches 1 run data modify storage minecraft:checkitem randomId append value 4
  ...
  execute if score gun ItemsBunker matches 3 run data modify storage minecraft:checkitem randomId append value 9
  execute if score harmonica ItemsBunker matches 1 run data modify storage minecraft:checkitem randomId append value 10
  ...
  execute if score cans ItemsBunker matches 1.. run data modify storage minecraft:checkitem randomId append value 15
  execute if score suitcase ItemsBunker matches 3 run data modify storage minecraft:checkitem randomId append value 16
  execute if score bottles ItemsBunker matches 1.. run data modify storage minecraft:checkitem randomId append value 17
  # Custom
