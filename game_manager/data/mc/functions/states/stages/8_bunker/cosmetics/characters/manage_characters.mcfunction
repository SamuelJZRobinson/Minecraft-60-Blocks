...
execute if score alive MaryStatus matches 1 unless score characterSent MenuExplore matches 2..3 unless score task AtomicDrill matches 13 unless score task AtomicDrill matches 18.. run function mc:states/stages/8_bunker/cosmetics/characters/update/update_mary
execute if score alive TedStatus matches 1 unless score characterSent MenuExplore matches 4 unless score task AtomicDrill matches 13 unless score task AtomicDrill matches 18.. run function mc:states/stages/8_bunker/cosmetics/characters/update/update_ted
execute if score alive TimmyStatus matches 1 unless score characterSent MenuExplore matches 5 unless score task AtomicDrill matches 13 unless score task AtomicDrill matches 18.. run function mc:states/stages/8_bunker/cosmetics/characters/update/update_timmy