...
execute if score gamemode Settings matches 2 run function mc:error_handling/raise_exception
...
execute if score gamemode Settings matches 4 run function mc:error_handling/raise_exception