...
execute if score alive DoloresStatus matches 1 unless score characterSent ChestMenuExplore matches 1 unless score task AtomicDrill matches 13 unless score task AtomicDrill matches 18.. run function mc:states/stages/7_bunker/decorations/characters/update/update_dolores
execute if score alive MaryStatus matches 1 unless score characterSent ChestMenuExplore matches 2..3 unless score task AtomicDrill matches 13 unless score task AtomicDrill matches 18.. run schedule function mc:states/stages/7_bunker/decorations/characters/update/update_mary_base 2t replace
execute if score alive TedStatus matches 1 unless score characterSent ChestMenuExplore matches 4 unless score task AtomicDrill matches 13 unless score task AtomicDrill matches 18.. run schedule function mc:states/stages/7_bunker/decorations/characters/update/update_ted 4t replace
