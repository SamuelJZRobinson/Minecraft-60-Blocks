...
# Mental Breakdown
  ...
  execute if score crazyRage DoloresStatus matches 1 if score itemCount ItemsBunker matches 1.. run function mc:states/stages/7_bunker/decorations/characters/set/set_crazy_dolores
  scoreboard players set math_out em 0
...
# Decorate Bunker
  # Spawn
  execute if score alive DoloresStatus matches 1 unless entity @e[x=-2,y=54,z=31,dy=4,dz=1,type=minecraft:armor_stand,tag=bunkerDolores] run function mc:states/stages/7_bunker/decorations/characters/spawn/spawn_dolores
  ...
  # Update Death
  execute if score alive DoloresStatus matches 0 as @e[x=-2,y=54,z=31,dy=4,dz=1,type=minecraft:armor_stand,tag=bunkerDolores] run function mc:states/stages/7_bunker/decorations/characters/update/update_dolores_dead