...
# Decorate Bunker
  # Spawn
  execute if score alive TedStatus matches 1 unless entity @e[x=0,y=54,z=31,dy=4,dz=1,type=minecraft:armor_stand,tag=bunkerTed] run function mc:states/stages/7_bunker/decorations/characters/spawn/spawn_ted
  ...
  # Update Death
  execute if score alive TedStatus matches 0 as @e[x=0,y=54,z=31,dy=4,dz=1,type=minecraft:armor_stand,tag=bunkerTed] run function mc:states/stages/7_bunker/decorations/characters/update/update_ted_dead