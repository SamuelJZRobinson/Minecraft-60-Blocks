...
# execute if score state GameStatus matches 5 run function mc:states/stages/5_atomic_drill/init_state
# execute if score state GameStatus matches 6 run function mc:states/stages/6_scavenge/init_state
# execute if score state GameStatus matches 7 run function mc:states/stages/7_bunker/init_state