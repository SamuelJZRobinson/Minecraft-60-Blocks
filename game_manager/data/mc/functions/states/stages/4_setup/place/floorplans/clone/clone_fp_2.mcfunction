...
# Props
execute unless entity @e[type=minecraft:item_frame,tag=calendar] run summon item_frame 30.00 65.50 -16.50 {Facing:5b,Invulnerable:1b,Fixed:1b,Tags:["house","houseProp","calendar"],Item:{id:"minecraft:filled_map",Count:1b,tag:{map:4}}}
...
schedule function mc:states/stages/4_setup/place/floorplans/spawn/spawn_checkers_fp_2 1t replace
schedule function mc:states/stages/4_setup/place/floorplans/tag/tag_fp_2 2t replace
