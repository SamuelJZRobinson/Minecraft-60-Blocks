...
# Goto Random Spaces And Remove Marker
  ...
  # Dolores
  execute if score doTed Settings matches 0 as @e[type=minecraft:zombie,tag=houseDolores,limit=1] run function mc:states/stages/4_setup/place/characters/teleport/tp_dolores
  # Mary Jane
  execute as @e[type=minecraft:zombie,tag=houseMary,limit=1] run function mc:states/stages/4_setup/place/characters/teleport/tp_mary
  # Timmy
  execute as @e[type=minecraft:zombie,tag=houseTimmy,limit=1] run function mc:states/stages/4_setup/place/characters/teleport/tp_timmy