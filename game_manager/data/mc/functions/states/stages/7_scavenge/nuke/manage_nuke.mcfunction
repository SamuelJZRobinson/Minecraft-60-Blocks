...
execute if score nukeSurvived GameStatus matches 1 run function mc:states/stages/7_scavenge/nuke/nuke_safe
execute if score nukeSurvived GameStatus matches 0 run function mc:states/stages/7_scavenge/nuke/nuke_dead
