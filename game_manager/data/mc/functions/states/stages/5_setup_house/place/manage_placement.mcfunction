...
# Floorplans
execute if score math_out em matches 1 run function mc:states/stages/5_setup_house/place/floorplans/clone/clone_floorplan1
execute if score math_out em matches 2 run function mc:states/stages/5_setup_house/place/floorplans/clone/clone_floorplan2
execute if score math_out em matches 3 run function mc:states/stages/5_setup_house/place/floorplans/clone/clone_floorplan3
execute if score math_out em matches 4 run function mc:states/stages/5_setup_house/place/floorplans/clone/clone_floorplan4
execute if score math_out em matches 5 run function mc:states/stages/5_setup_house/place/floorplans/clone/clone_floorplan5
execute if score math_out em matches 6 run function mc:states/stages/5_setup_house/place/floorplans/clone/clone_floorplan6
