...
# Clone Structures
  # Triple Rooms
  execute unless score floorplan GameStatus matches 5 run clone 3 6 2 -23 1 -9 9 63 -23 replace normal
  # Hallway
  execute unless score floorplan GameStatus matches 5 run clone 42 6 2 5 1 -6 5 63 -11 replace normal
  # Double Rooms
  execute unless score floorplan GameStatus matches 5 run clone 65 6 2 44 1 -9 9 63 -2 replace normal
...
schedule function mc:states/stages/5_setup_house/place/floorplans/spawn/spawn_floorplan5_checkers 7t replace
