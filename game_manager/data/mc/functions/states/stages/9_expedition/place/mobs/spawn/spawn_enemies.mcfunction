...
execute if score loadMob MobsExpedition matches 5 run schedule schedule function mc:states/stages/9_expedition/place/manage_placement 1t replace 1t replace
