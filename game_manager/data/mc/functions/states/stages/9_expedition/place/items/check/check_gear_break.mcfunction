# Auto
execute if score doPovExpedition Settings matches 0 if data storage minecraft:bundles expeditionGearId run function mc:states/stages/9_expedition/place/items/set/set_gear_break
