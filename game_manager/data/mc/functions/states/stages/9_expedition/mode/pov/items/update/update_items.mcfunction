# Update Subway Map
execute if score locationVisited MenuExplore matches 7 as @p[team=Playing,nbt={SelectedItem:{id:"minecraft:filled_map"}}] run function mc:states/stages/9_expedition/mode/pov/items/update/update_items_map
