# Task 1 (Goto Hallway Marker)
  ...
  # Effects
  execute if score task AtomicDrill matches 1 run effect give @p[Mobsteam=Player] speed 999999 1 true
...
# Task 6 (Salvage Items)
  ...
  execute if score task AtomicDrill matches 6 run function mc:states/4_setup/place/floorplans/spawn/spawn_bunker_indicator
...
# Task 9 (Salvage Items)
  ...
  # Create Marker
  execute if score task AtomicDrill matches 9 run function mc:states/4_setup/place/floorplans/spawn/spawn_bunker_indicator
...
# Task 21 (Final Words And Reset, Day Ten)
  ...
  # Break The Script
  execute if score task AtomicDrill matches 21 run schedule clear mc:states/5_drill_start/task/task_loop

# Request Dialogue
execute unless score task AtomicDrill matches 13.. run function mc:states/5_drill_start/show/show_dialogue_loop
