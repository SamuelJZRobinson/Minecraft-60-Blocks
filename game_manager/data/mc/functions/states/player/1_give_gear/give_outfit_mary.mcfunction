# Give Outfit
execute if score mutated MaryStatus matches 0 run item replace entity @s armor.head with pumpkin{display:{Name:'{"text":"Mary"}'},CustomModelData:3,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]} 1
execute if score mutated MaryStatus matches 1 run item replace entity @s armor.head with pumpkin{display:{Name:'{"text":"Mutant Mary"}'},CustomModelData:4,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]} 1
