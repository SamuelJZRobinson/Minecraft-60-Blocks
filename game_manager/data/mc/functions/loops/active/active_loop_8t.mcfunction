...
# execute if score state GameStatus matches 8 run function mc:states/7_bunker/cosmetics/bunker/update/update_blackout
...
# Player Related
  ...
  # Fake Blindness
  execute if score fakeBlindness GameStatus matches 1.. as @p[team=Player] run function mc:utility/vision/manage_fake_blindness
  # Inventory
...
# Expedition
  # Map Update
  execute if score state GameStatus matches 9 run function mc:states/8_expedition/place/items/update/update_items
