...
execute if score specialCount ItemsExpedition matches 0 run function mc:events/random_loadout/locations/items/set_loot_slot

# Loop
execute if score specialCount ItemsExpedition matches 1.. run function mc:events/random_loadout/locations/items/set_loot_slot_try