...
# Loop
execute if score loadItem ItemsExpedition matches 1..3 if score itemsOwed CheckItems matches 1.. run function mc:utility/scavenge/check_item/check_random