# Teleport Locations
execute if score mapVisited MenuExplore matches 1 run spreadplayers -129.00 -383.00 8 56 under 303 false @e[team=Enemy]
...
execute if score mapVisited MenuExplore matches 2 run spreadplayers 0.00 -383.00 8 56 under 296 false @e[team=Enemy]
...
execute if score mapVisited MenuExplore matches 3 run spreadplayers 129.00 -383.00 8 40 under 304 false @e[team=Enemy]
...
execute if score mapVisited MenuExplore matches 4 run spreadplayers -129.00 -254.00 8 56 under 297 false @e[team=Enemy]
...
execute if score mapVisited MenuExplore matches 5 run spreadplayers -0.00 -254.00 8 56 under 297 false @e[team=Enemy]
...
execute if score mapVisited MenuExplore matches 6 run spreadplayers 129.00 -254.00 8 40 under 296 false @e[team=Enemy]
...
execute if score mapVisited MenuExplore matches 7 run spreadplayers -129.00 -125.00 8 56 under 308 false @e[team=Enemy]
...
execute if score mapVisited MenuExplore matches 8 run spreadplayers -0.00 -125.00 8 54 under 298 false @e[team=Enemy]
