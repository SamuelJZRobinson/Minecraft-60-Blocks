...
execute if score stage ItemsExpedition matches 6 if score doPovExpedition Settings matches 1 run schedule function mc:states/stages/9_expedition/place/mobs/spawn/spawn_enemies 1t replace
