...
# Revive Chance
  ...
  execute if score survivedNuke DoloresStatus matches 0 run function mc:events/random_loadout/house/items/get_percentage
  ...
  scoreboard players operation memory em = REVIVE StatusOdds
  execute if score survivedNuke MaryStatus matches 0 run function mc:events/random_loadout/house/items/get_percentage
  ...
  # Ted (1 in x, n+1)
  scoreboard players operation memory em = REVIVE StatusOdds
  execute if score survivedNuke TedStatus matches 0 run function mc:events/random_loadout/house/items/get_percentage
  ...
  # Timmy (1 in x, n+1)
  scoreboard players operation memory em = REVIVE StatusOdds
  execute if score survivedNuke TimmyStatus matches 0 run function mc:events/random_loadout/house/items/get_percentage
