...
# Fatigue
  ...
  execute if score fatigued DoloresStatus matches 0 if score day GameStatus >= FATIGUE_MIN StatusLevels if score day GameStatus <= FATIGUE_MAX StatusLevels run function mc:events/random_loadout/house/items/get_percentage
...
# Injuries
  ...
  execute if score alive DoloresStatus matches 1 if score sick DoloresStatus matches 0 if score infection DoloresStatus <= INFECTION_MIN StatusLevels run function mc:events/random_loadout/house/items/get_percentage
...
# Crazy
  ...
  execute if score alive DoloresStatus matches 1 if score crazy DoloresStatus matches 0 if score sanity DoloresStatus = SANITY_MIN StatusLevels run function mc:events/random_loadout/house/items/get_percentage
...
# Mental Breakdown
  ...
  execute if score alive DoloresStatus matches 1 if score crazyRage DoloresStatus matches 0 if score breakdown DoloresStatus <= BREAKDOWN_RAGE_MAX StatusLevels if score breakdown DoloresStatus > BREAKDOWN_MIN StatusLevels run function mc:events/random_loadout/house/items/get_percentage
  ...
  execute if score alive DoloresStatus matches 1 if score breakdown DoloresStatus <= BREAKDOWN_MIN StatusLevels run function mc:events/random_loadout/house/items/get_percentage
...
# Sickness
  ...
  # Malnutrition Chance (1 in x, n+1)
    ...
    execute if score alive DoloresStatus matches 1 if score sick DoloresStatus matches 0 if score soup DoloresStatus > HUNGER_MIN StatusLevels if score water DoloresStatus <= THIRST_MIN StatusLevels run function mc:events/random_loadout/house/items/get_percentage
    # No Soup, Has Water
  ...
  execute if score alive DoloresStatus matches 1 if score sickness DoloresStatus <= SICKNESS_MIN StatusLevels run function mc:events/random_loadout/house/items/get_percentage
