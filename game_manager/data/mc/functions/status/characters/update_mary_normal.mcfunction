...
# Fatigue
  ...
  execute if score fatigued MaryStatus matches 0 if score day GameStatus >= FATIGUE_MIN StatusLevels if score day GameStatus <= FATIGUE_MAX StatusLevels run function mc:states/stages/5_setup_house/place/items/get_percentage
...
# Injuries
  ...
  execute if score alive MaryStatus matches 1 if score sick MaryStatus matches 0 if score infection MaryStatus <= INFECTION_MIN StatusLevels run function mc:states/stages/5_setup_house/place/items/get_percentage
...
# Crazy
  ...
  execute if score alive MaryStatus matches 1 if score crazy MaryStatus matches 0 if score sanity MaryStatus = SANITY_MIN StatusLevels run function mc:states/stages/5_setup_house/place/items/get_percentage
...
# Mental Breakdown
  ...
  execute if score alive MaryStatus matches 1 if score crazyRage MaryStatus matches 0 if score breakdown MaryStatus <= BREAKDOWN_RAGE_MAX StatusLevels if score breakdown MaryStatus > BREAKDOWN_MIN StatusLevels run function mc:states/stages/5_setup_house/place/items/get_percentage
  ...
  execute if score alive MaryStatus matches 1 if score breakdown MaryStatus <= BREAKDOWN_MIN StatusLevels run function mc:states/stages/5_setup_house/place/items/get_percentage
...
# Sickness
  ...
  # Malnutrition Chance (1 in x, n+1)
    ...
    execute if score alive MaryStatus matches 1 if score sick MaryStatus matches 0 if score soup MaryStatus > HUNGER_MIN StatusLevels if score water MaryStatus <= THIRST_MIN StatusLevels run function mc:states/stages/5_setup_house/place/items/get_percentage
    # No Soup, Has Water
  ...
  execute if score alive MaryStatus matches 1 if score sickness MaryStatus <= SICKNESS_MIN StatusLevels run function mc:states/stages/5_setup_house/place/items/get_percentage
