...
execute if score flashlight ItemsBunker matches 1 if entity @s[tag=!setModel] run kill @e[x=-3,y=54,z=29,dx=6,dy=4,dz=6,type=minecraft:area_effect_cloud,tag=hitboxFlashlight]
...
execute if score flashlight ItemsBunker matches 0 run kill @e[x=-3,y=54,z=29,dx=6,dy=4,dz=6,tag=bunkerFlashlight]
