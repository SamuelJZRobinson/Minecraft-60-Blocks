# Update Subway Map
execute if score locationVisited ChestMenuExplore matches 7 as @p[team=Playing,nbt={SelectedItem:{id:"minecraft:filled_map"}}] run function mc:timer/expedition/update_map_check
