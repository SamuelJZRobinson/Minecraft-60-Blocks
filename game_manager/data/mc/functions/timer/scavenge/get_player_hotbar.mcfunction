...
execute if score gamemode Settings matches 1 run function mc:timer/scavenge/get_player_hotbar_count
execute if score gamemode Settings matches 3 run function mc:timer/scavenge/get_player_hotbar_count
# Clear Inventory
