...
# Characters
  ...
  scoreboard players operation water TedStatus = THIRST_AMOUNT_DANGER StatusLevels
  # Dolores
  scoreboard players set alive DoloresStatus 1
  scoreboard players set soup DoloresStatus 100
  scoreboard players operation water DoloresStatus = THIRST_AMOUNT_DANGER StatusLevels
  # Mary
  scoreboard players set alive MaryStatus 1
  scoreboard players set soup MaryStatus 100
  scoreboard players operation water MaryStatus = THIRST_AMOUNT_DANGER StatusLevels
  # Timmy
  scoreboard players set alive TimmyStatus 1
  scoreboard players set soup TimmyStatus 100
  scoreboard players operation water TimmyStatus = THIRST_AMOUNT_DANGER StatusLevels
