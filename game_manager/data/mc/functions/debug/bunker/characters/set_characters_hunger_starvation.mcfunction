...
# Characters
  ...
  scoreboard players operation soup TedStatus = HUNGER_AMOUNT_CRITICAL StatusLevels
  scoreboard players set water TedStatus 100
  # Dolores
  scoreboard players set alive DoloresStatus 1
  scoreboard players operation soup DoloresStatus = HUNGER_AMOUNT_CRITICAL StatusLevels
  scoreboard players set water DoloresStatus 100
  # Mary
  scoreboard players set alive MaryStatus 1
  scoreboard players operation soup MaryStatus = HUNGER_AMOUNT_CRITICAL StatusLevels
  scoreboard players set water MaryStatus 100
  # Timmy
  scoreboard players set alive TimmyStatus 1
  scoreboard players operation soup TimmyStatus = HUNGER_AMOUNT_CRITICAL StatusLevels
