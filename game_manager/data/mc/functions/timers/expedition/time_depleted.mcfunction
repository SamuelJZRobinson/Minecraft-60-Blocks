...
# Time Depleted
  ...
  execute as @p[team=Playing] run function mc:timers/expedition/clear_location_entities
...
execute if score expeditionMode Lobby matches 1 unless score expeditionDeath AtomicDrill matches 1.. run function mc:timers/expedition/get_player_inventory
