...
execute if score rotate ChestMenuExplore matches 5 as @p[team=Playing] run function mc:timers/scavenge/clear_all
execute if score rotate ChestMenuExplore matches 5 run scoreboard players set blindness GameStatus 3
...
# Loop
execute if score rotate ChestMenuExplore matches 1..5 run schedule function mc:timers/expedition/clear_location_rotate 3t replace