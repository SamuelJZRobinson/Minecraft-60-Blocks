...
# Dolores
execute if score alive DoloresStatus matches 1 run function cm:pages/expedition/menus/menu_characters_dolores
...
# Mary
execute if score alive MaryStatus matches 1 run function cm:pages/expedition/menus/menu_characters_mary
...
# Timmy
execute if score alive TimmyStatus matches 1 run function cm:pages/expedition/menus/menu_characters_timmy
