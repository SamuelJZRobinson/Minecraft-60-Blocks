...
# Prepare Expedition
execute if score expeditionReady MenuExpedition matches 0 run function cm:pages/expedition/menus/menu_expedition_prepare

# Expedition Ready
execute if score expeditionReady MenuExpedition matches 1 if score characterSent MenuExpedition matches 0 run function cm:pages/expedition/menus/menu_expedition_ready

# Icons
function cm:pages/expedition/menus/menu_icons
