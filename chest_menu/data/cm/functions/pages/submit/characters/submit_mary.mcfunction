# Nourish
  # Soup
    # Normal
    execute if score maryGiveCan MenuFeed matches 1 if score mutated MaryStatus matches 0 run scoreboard players operation soup MaryStatus = HUNGER_MAX StatusLevels
    # Mutant
    execute if score maryGiveCan MenuFeed matches 1 if score mutated MaryStatus matches 1 run scoreboard players operation soup MaryStatus += HUNGER_MID StatusLevels
    ...
    # Water
    execute if score maryGiveBottle MenuFeed matches 1 run scoreboard players operation water MaryStatus = THIRST_MAX StatusLevels
    # Medkit
