# Nourish
  # Soup
    # Normal
    execute if score maryGiveSoup MenuFeed matches 1 if score mutant MaryStatus matches 0 run scoreboard players operation soup MaryStatus = HUNGER_MAX StatusLevels
    # Mutant
    execute if score maryGiveSoup MenuFeed matches 1 if score mutant MaryStatus matches 1 run scoreboard players operation soup MaryStatus += HUNGER_MID StatusLevels
