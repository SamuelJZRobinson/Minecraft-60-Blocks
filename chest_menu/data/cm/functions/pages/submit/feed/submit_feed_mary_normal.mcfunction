# Give Supplies
  # Soup
  execute if score maryGiveSoup MenuFeed matches 1 run scoreboard players operation soup MaryStatus = HUNGER_AMOUNT_MAX CharactersLevels
  # Water
  execute if score maryGiveWater MenuFeed matches 1 run scoreboard players operation water MaryStatus = THIRST_AMOUNT_MAX CharactersLevels
  # Medkit
