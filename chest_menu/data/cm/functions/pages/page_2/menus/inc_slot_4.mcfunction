...
execute if score slotFour MenuExplore matches 17 if score soups ItemsBunker matches ..3 run scoreboard players add slotFour MenuExplore 1
execute if score slotFour MenuExplore matches 18 if score waters ItemsBunker matches ..3 run scoreboard players add slotFour MenuExplore 1
