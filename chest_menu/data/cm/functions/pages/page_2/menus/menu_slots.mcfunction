# Slot 1
  ...
  execute if score characterSelect MenuExplore matches 3 if score isMutant MaryStatus matches 1 run scoreboard players set slotOne MenuExplore -1
  # Refresh Cycle If Items Exist
  execute if score itemCount ItemsBunker matches 1.. run function cm:pages/page_2/menus/menu_slots_slot_1
...
# Slot 2
  ...
  execute if score characterSelect MenuExplore matches 3 if score isMutant MaryStatus matches 1 run scoreboard players set slotTwo MenuExplore -1
...
# Slot 3
  ...
  execute if score characterSelect MenuExplore matches 3 if score isMutant MaryStatus matches 1 run scoreboard players set slotThree MenuExplore -1
...
# Slot 4
  ...
  execute if score characterSelect MenuExplore matches 3 if score isMutant MaryStatus matches 1 run scoreboard players set slotFour MenuExplore -1
