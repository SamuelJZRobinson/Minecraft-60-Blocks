...
# Character Toggle
  ...
  execute if score alive DoloresStatus matches 0 run data modify block -8 -48 -9 Items insert 0 value {Slot:0b,id:"minecraft:saddle",Count:1b,tag:{CustomModelData:93,isMenu:1b,page:2,selection:0,display:{Name:'{"text":"Locked","color":"red","bold":true}',Lore:['{"text":"Requires Dolores","color":"dark_red"}']}}}
  # Mary
  execute if score alive MaryStatus matches 1 run function cm:pages/page_2/menus/menu_expedition_mary
  execute if score alive MaryStatus matches 0 run data modify block -8 -48 -9 Items insert 0 value {Slot:1b,id:"minecraft:saddle",Count:1b,tag:{CustomModelData:98,isMenu:1b,page:2,selection:0,display:{Name:'{"text":"Locked","color":"red","bold":true}',Lore:['{"text":"Requires Mary","color":"dark_red"}']}}}
  # Ted
  execute if score alive TedStatus matches 1 run function cm:pages/page_2/menus/menu_expedition_ted
  execute if score alive TedStatus matches 0 run data modify block -8 -48 -9 Items insert 0 value {Slot:2b,id:"minecraft:saddle",Count:1b,tag:{CustomModelData:107,isMenu:1b,page:2,selection:0,display:{Name:'{"text":"Locked","color":"red","bold":true}',Lore:['{"text":"Requires Ted","color":"dark_red"}']}}}
  # Timmy
  execute if score alive TimmyStatus matches 1 run function cm:pages/page_2/menus/menu_expedition_timmy
  execute if score alive TimmyStatus matches 0 run data modify block -8 -48 -9 Items insert 0 value {Slot:3b,id:"minecraft:saddle",Count:1b,tag:{CustomModelData:104,isMenu:1b,page:2,selection:0,display:{Name:'{"text":"Locked","color":"red","bold":true}',Lore:['{"text":"Requires Timmy","color":"dark_red"}']}}}
...
# Map Choice (Mandatory)
  # Neighbourhood
    ...
    # Toggle
    execute if score mapSelect MenuExplore matches 2 run data modify block -8 -48 -9 Items insert 0 value {Slot:6b,id:"minecraft:saddle",Count:1b,tag:{CustomModelData:36,isMenu:1b,page:2,selection:0,display:{Name:'{"text":"Visit neighbourhood","color":"gray","bold":true}'}}}
    ...
    # Lore
    data modify block -8 -48 -9 Items[{Slot:6b}].tag.display.Lore append value '{"text":"Distance: short","color":"dark_green"}'
  # Load Locations
...
# Gear
  # Slot 1
    ...
    execute if score slotOne MenuExplore matches -1 run loot replace block -8 -48 -9 container.9 loot cm:chests/locked_no_items
  ...
  # Slot 2
    ...
    execute if score slotTwo MenuExplore matches -1 run loot replace block -8 -48 -9 container.10 loot cm:chests/locked_no_items
    execute if score suitcase ItemsBunker matches 0 run scoreboard players set slotTwo MenuExplore 0
    execute if score slotTwo MenuExplore matches 0 run loot replace block -8 -48 -9 container.10 loot cm:chests/locked_no_suitcase
  ...
  # Slot 3
    ...
    execute if score slotThree MenuExplore matches -1 run loot replace block -8 -48 -9 container.11 loot cm:chests/locked_no_items
    execute if score suitcase ItemsBunker matches 0 run scoreboard players set slotThree MenuExplore 0
    execute if score slotThree MenuExplore matches 0 run loot replace block -8 -48 -9 container.11 loot cm:chests/locked_no_suitcase
    # Restart Cycle If Items Exist And Suitcase Is Active
  ...
  # Slot 4
    ...
    execute if score slotFour MenuExplore matches -1 run loot replace block -8 -48 -9 container.12 loot cm:chests/locked_no_items
    execute if score suitcase ItemsBunker matches 0 run scoreboard players set slotFour MenuExplore 0
    execute if score slotFour MenuExplore matches 0 run loot replace block -8 -48 -9 container.12 loot cm:chests/locked_no_suitcase
    # Restart Cycle If Items Exist And Suitcase Is Active
