...
# Map Choice (Mandatory)
  # Neighbourhood
    ...
    # Toggle
    execute if score mapSelect MenuExplore matches 2 run data modify block ~ ~ ~ Items insert 0 value {Slot:5b,id:"minecraft:saddle",Count:1b,tag:{CustomModelData:36,isMenu:1b,page:2,selection:0,display:{Name:'{"text":"Visit neighbourhood","color":"gray","bold":true}'}}}
