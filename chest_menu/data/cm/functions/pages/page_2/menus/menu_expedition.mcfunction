...
# Character Toggle
  # Dolores
  execute if score alive DoloresStatus matches 1 run function cm:pages/page_2/update_dolores
  ...
  # Mary
  execute if score alive MaryStatus matches 1 run function cm:pages/page_2/update_mary
  ...
  # Ted
  execute if score alive TedStatus matches 1 run function cm:pages/page_2/update_ted
  ...
  # Timmy
  execute if score alive TimmyStatus matches 1 run function cm:pages/page_2/update_timmy
...
# Location Choice (Mandatory)
  ...
  # Load Locations
  execute if score map ItemsBunker matches 1 run function cm:pages/page_2/update_locations
  execute if score map ItemsBunker matches ..0 run function cm:pages/page_2/lock_locations
...
# Gear
  # Slot 1
    ...
    execute unless score characterSelect ChestMenuExplore matches 3 if score itemCount ItemsBunker matches 1.. run function cm:pages/page_2/update_slot1
  ...
  # Slot 2
    ...
    execute if score itemCount ItemsBunker matches 2.. if score slotOne ChestMenuExplore matches 2 run function cm:pages/page_2/update_slot2
  ...
  # Slot 3
    ...
    # Restart Cycle If Items Exist And Suitcase Is Active
    execute if score itemCount ItemsBunker matches 3.. if score slotOne ChestMenuExplore matches 2 run function cm:pages/page_2/update_slot3
  ...
  # Slot 4
    ...
    # Restart Cycle If Items Exist And Suitcase Is Active
    execute if score itemCount ItemsBunker matches 4.. if score slotOne ChestMenuExplore matches 2 run function cm:pages/page_2/update_slot4