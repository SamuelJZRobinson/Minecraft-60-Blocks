...
# Character Selection
  # Dolores
  execute if score alive DoloresStatus matches 1 unless score characterSent ChestMenuExplore matches 1 run function cm:pages/page_1/menus/menu_dolores
  ...
  # Mary
  execute if score alive MaryStatus matches 1 unless score characterSent ChestMenuExplore matches 2..3 run function cm:pages/page_1/menus/menu_mary
  ...
  # Ted
  execute if score alive TedStatus matches 1 unless score characterSent ChestMenuExplore matches 4 run function cm:pages/page_1/menus/menu_ted
  ...
  # Timmy
  execute if score alive TimmyStatus matches 1 unless score characterSent ChestMenuExplore matches 5 run function cm:pages/page_1/menus/menu_timmy
