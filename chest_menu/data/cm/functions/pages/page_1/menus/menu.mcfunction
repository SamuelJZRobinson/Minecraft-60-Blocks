...
# Character Selection
  ...
  execute if score alive DoloresStatus matches 0 run data modify block ~ ~ ~ Items insert 0 value {Slot:0b,id:"minecraft:saddle",Count:1b,tag:{CustomModelData:93,isMenu:1b,page:1,selection:0,display:{Name:'{"text":"Locked","color":"red","bold":true}',Lore:['{"text":"Requires Dolores","color":"dark_red"}']}}}
  # Mary
  ...
  execute if score alive MaryStatus matches 0 run data modify block ~ ~ ~ Items insert 0 value {Slot:5b,id:"minecraft:saddle",Count:1b,tag:{CustomModelData:98,isMenu:1b,page:1,selection:0,display:{Name:'{"text":"Locked","color":"red","bold":true}',Lore:['{"text":"Requires Mary","color":"dark_red"}']}}}
  # Ted
  ...
  execute if score alive TedStatus matches 0 run data modify block ~ ~ ~ Items insert 0 value {Slot:9b,id:"minecraft:saddle",Count:1b,tag:{CustomModelData:107,isMenu:1b,page:1,selection:0,display:{Name:'{"text":"Locked","color":"red","bold":true}',Lore:['{"text":"Requires Ted","color":"dark_red"}']}}}
  # Timmy
  ...
  execute if score alive TimmyStatus matches 0 run data modify block ~ ~ ~ Items insert 0 value {Slot:14b,id:"minecraft:saddle",Count:1b,tag:{CustomModelData:104,isMenu:1b,page:1,selection:0,display:{Name:'{"text":"Locked","color":"red","bold":true}',Lore:['{"text":"Requires Timmy","color":"dark_red"}']}}}
...
# Mass Items
  # Soup
    ...
    # Lock
    execute if score soups ItemsBunker < totalPresent GameStatus run data modify block ~ ~ ~ Items insert 0 value {Slot:21b,id:"minecraft:saddle",Count:1b,tag:{CustomModelData:102,isMenu:1b,page:1,selection:0,display:{Name:'{"text":"Locked","color":"red","bold":true}',Lore:['{"text":"Requires more soup","color":"dark_red"}']}}}

  # Water
    # Toggle
    execute if score waters ItemsBunker >= totalPresent GameStatus if score waterGiven MenuFeed < totalPresent GameStatus run data modify block ~ ~ ~ Items insert 0 value {Slot:23b,id:"minecraft:saddle",Count:1b,tag:{CustomModelData:79,isMenu:1b,page:1,selection:39,display:{Name:'{"text":"Keep all water","color":"gray","bold":true}',Lore:['{"text":"Click to add all","color":"dark_gray","underlined":true}']}}}
    ...
    # Lock
    execute if score waters ItemsBunker < totalPresent GameStatus run data modify block ~ ~ ~ Items insert 0 value {Slot:23b,id:"minecraft:saddle",Count:1b,tag:{CustomModelData:105,isMenu:1b,page:1,selection:0,display:{Name:'{"text":"Locked","color":"red","bold":true}',Lore:['{"text":"Requires more water","color":"dark_red"}']}}}
