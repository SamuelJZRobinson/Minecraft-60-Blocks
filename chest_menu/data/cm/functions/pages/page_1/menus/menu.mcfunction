...
# Page Buttons
  # Back
  data modify block ~ ~ ~ Items insert 0 value {Slot:18b,id:"minecraft:saddle",Count:1b,tag:{CustomModelData:29,isMenu:1b,page:1,selection:2,display:{Name:'{"text":"Goto notices menu","color":"gray","bold":true}'}}}
  # Next
  ...
  execute if score task AtomicDrill matches 14 if score waterGiven MenuFeed >= totalPresent GameStatus run data modify block ~ ~ ~ Items insert 0 value {Slot:26b,id:"minecraft:saddle",Count:1b,tag:{CustomModelData:30,isMenu:1b,page:1,selection:1,display:{Name:'{"text":"Goto expedition menu","color":"gray","bold":true}'}}}
  # Submit
