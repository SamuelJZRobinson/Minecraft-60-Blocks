...
# Player Head
  ...
  execute if score injuredDays DoloresStatus > INJURED_DAYS_DEATH StatusLevels if score injuredDays DoloresStatus < INJURED_DAYS_CRITICAL StatusLevels run data modify block ~ ~ ~ Items[{Slot:0b}].tag.display.Lore append value '{"text":"Hurt","color":"gold"}'
  execute if score injuredDays DoloresStatus <= INJURED_DAYS_DEATH StatusLevels run data modify block ~ ~ ~ Items[{Slot:0b}].tag.display.Lore append value '{"text":"Agony","color":"gold"}'
