...
# Player Head
  ...
  execute if score doloresHead MenuFeed matches 3 run data modify block 0 54 29 Items[{Slot:0b}].tag.display.Lore append value '{"text":"Click to add water","color":"dark_gray","underlined":true}'
  execute if score doloresHead MenuFeed matches 4 run data modify block 0 54 29 Items[{Slot:0b}].tag.display.Lore append value '{"text":"Click to remove water","color":"dark_gray","underlined":true}'
  execute if score doloresHead MenuFeed matches 5 run data modify block 0 54 29 Items[{Slot:0b}].tag.display.Lore append value '{"text":"Click to add soup","color":"dark_gray","underlined":true}'
  execute if score doloresHead MenuFeed matches 6 run data modify block 0 54 29 Items[{Slot:0b}].tag.display.Lore append value '{"text":"Click to add soup","color":"dark_gray","underlined":true}'
  execute if score doloresHead MenuFeed matches 7 run data modify block 0 54 29 Items[{Slot:0b}].tag.display.Lore append value '{"text":"Click to remove soup","color":"dark_gray","underlined":true}'
  execute if score doloresHead MenuFeed matches 8 run data modify block 0 54 29 Items[{Slot:0b}].tag.display.Lore append value '{"text":"Click to add both","color":"dark_gray","underlined":true}'
  execute if score doloresHead MenuFeed matches 9 run data modify block 0 54 29 Items[{Slot:0b}].tag.display.Lore append value '{"text":"Requires more items","color":"dark_red"}'
  # Status Effects Lore
