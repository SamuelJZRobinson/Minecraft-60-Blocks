...
# Multi Soup And Water
  ...
  execute if score tedMultiAction MenuFeed matches 1 run data modify block ~ ~ ~ Items[{Slot:9b}].tag.display.Lore append value '{"text":"Click to add both","color":"dark_gray","underlined":true}'
  execute if score tedMultiAction MenuFeed matches 2 run data modify block ~ ~ ~ Items[{Slot:9b}].tag.display.Lore append value '{"text":"Click to add soup","color":"dark_gray","underlined":true}'
  execute if score tedMultiAction MenuFeed matches 3 run data modify block ~ ~ ~ Items[{Slot:9b}].tag.display.Lore append value '{"text":"Click to add water","color":"dark_gray","underlined":true}'
  execute if score tedMultiAction MenuFeed matches 4 run data modify block ~ ~ ~ Items[{Slot:9b}].tag.display.Lore append value '{"text":"Click to remove both","color":"dark_gray","underlined":true}'
# Soup
  # Toggle
