# Player Head
  ...
  # Status Effects Lore
  execute if score fatigued MaryStatus matches 1 run data modify block ~ ~ ~ Items[{Slot:5b}].tag.display.Lore append value '{"text":"Fatigued","color":"gold"}'
  execute if score soupLevel MaryStatus matches 1 run data modify block ~ ~ ~ Items[{Slot:5b}].tag.display.Lore append value '{"text":"Hungry","color":"gold"}'
  execute if score soupLevel MaryStatus matches 2 run data modify block ~ ~ ~ Items[{Slot:5b}].tag.display.Lore append value '{"text":"Starvation","color":"gold"}'
  execute if score injuredLevel MaryStatus matches 1 run data modify block ~ ~ ~ Items[{Slot:5b}].tag.display.Lore append value '{"text":"Hurt","color":"gold"}'
  execute if score injuredLevel MaryStatus matches 2 run data modify block ~ ~ ~ Items[{Slot:5b}].tag.display.Lore append value '{"text":"Agony","color":"gold"}'
  execute if score crazy MaryStatus matches 1 run data modify block ~ ~ ~ Items[{Slot:5b}].tag.display.Lore append value '{"text":"Crazy","color":"gold"}'
  execute if score sick MaryStatus matches 1 run data modify block ~ ~ ~ Items[{Slot:5b}].tag.display.Lore append value '{"text":"Sick","color":"gold"}'
  execute if score waterLevel MaryStatus matches 1 run data modify block ~ ~ ~ Items[{Slot:5b}].tag.display.Lore append value '{"text":"Thirsty","color":"gold"}'
  execute if score waterLevel MaryStatus matches 2 run data modify block ~ ~ ~ Items[{Slot:5b}].tag.display.Lore append value '{"text":"Dehydration","color":"gold"}'
  execute if score tired MaryStatus matches 1.. run data modify block ~ ~ ~ Items[{Slot:5b}].tag.display.Lore append value '{"text":"Tired","color":"gold"}'
...
# Medkit
  ...
  execute if score medkit ItemsBunker matches 2 if score giveMedkit MenuFeed matches 0.. if score injured MaryStatus matches 1 run data modify block ~ ~ ~ Items insert 0 value {Slot:8b,id:"minecraft:saddle",Count:1b,tag:{CustomModelData:73,isMenu:1b,page:1,selection:19,display:{Name:'{"text":"Keep medkit","color":"gray","bold":true}',Lore:['{"text":"Click to add","color":"dark_gray","underlined":true}']}}}
  execute if score medkit ItemsBunker matches 2 if score giveMedkit MenuFeed matches 0.. if score sick MaryStatus matches 1 run data modify block ~ ~ ~ Items insert 0 value {Slot:8b,id:"minecraft:saddle",Count:1b,tag:{CustomModelData:73,isMenu:1b,page:1,selection:19,display:{Name:'{"text":"Keep medkit","color":"gray","bold":true}',Lore:['{"text":"Click to add","color":"dark_gray","underlined":true}']}}}
  # Lock
  execute if score medkit ItemsBunker matches ..0 if score injured MaryStatus matches 1 run data modify block ~ ~ ~ Items insert 0 value {Slot:8b,id:"minecraft:saddle",Count:1b,tag:{CustomModelData:99,isMenu:1b,page:1,selection:0,display:{Name:'{"text":"Locked","color":"red","bold":true}',Lore:['{"text":"Requires medkit","color":"dark_red"}']}}}
  execute if score medkit ItemsBunker matches ..0 if score sick MaryStatus matches 1 run data modify block ~ ~ ~ Items insert 0 value {Slot:8b,id:"minecraft:saddle",Count:1b,tag:{CustomModelData:99,isMenu:1b,page:1,selection:0,display:{Name:'{"text":"Locked","color":"red","bold":true}',Lore:['{"text":"Requires medkit","color":"dark_red"}']}}}