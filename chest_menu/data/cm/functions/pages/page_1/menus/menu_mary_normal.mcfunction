# Player Head
  ...
  execute if score injuryInfectionCountdown MaryStatus > INJURY_INFECTION_COUNTDOWN_MIN StatusLevels if score injuryInfectionCountdown MaryStatus < INJURY_INFECTION_COUNTDOWN_MAX StatusLevels run data modify block ~ ~ ~ Items[{Slot:5b}].tag.display.Lore append value '{"text":"Hurt","color":"gold"}'
  execute if score injuryInfectionCountdown MaryStatus <= INJURY_INFECTION_COUNTDOWN_MIN StatusLevels run data modify block ~ ~ ~ Items[{Slot:5b}].tag.display.Lore append value '{"text":"Agony","color":"gold"}'
