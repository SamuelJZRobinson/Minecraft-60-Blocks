# Player Head
  ...
  execute if score injuredDays TimmyStatus > INJURED_DAYS_DEATH StatusLevels if score injuredDays TimmyStatus < INJURED_DAYS_CRITICAL StatusLevels run data modify block ~ ~ ~ Items[{Slot:14b}].tag.display.Lore append value '{"text":"Hurt","color":"gold"}'
  execute if score injuredDays TimmyStatus <= INJURED_DAYS_DEATH StatusLevels run data modify block ~ ~ ~ Items[{Slot:14b}].tag.display.Lore append value '{"text":"Agony","color":"gold"}'
