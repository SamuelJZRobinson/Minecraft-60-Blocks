# Player Head
  ...
  # Action Lore
  execute if score timmyHead MenuFeed matches 1 run data modify block ~ ~ ~ Items[{Slot:14b}].tag.display.Lore append value '{"text":"Click to remove both","color":"dark_gray","underlined":true}'
  execute if score timmyHead MenuFeed matches 2 run data modify block ~ ~ ~ Items[{Slot:14b}].tag.display.Lore append value '{"text":"Click to add water","color":"dark_gray","underlined":true}'
  execute if score timmyHead MenuFeed matches 3 run data modify block ~ ~ ~ Items[{Slot:14b}].tag.display.Lore append value '{"text":"Click to add water","color":"dark_gray","underlined":true}'
  execute if score timmyHead MenuFeed matches 4 run data modify block ~ ~ ~ Items[{Slot:14b}].tag.display.Lore append value '{"text":"Click to remove water","color":"dark_gray","underlined":true}'
  execute if score timmyHead MenuFeed matches 5 run data modify block ~ ~ ~ Items[{Slot:14b}].tag.display.Lore append value '{"text":"Click to add soup","color":"dark_gray","underlined":true}'
  execute if score timmyHead MenuFeed matches 6 run data modify block ~ ~ ~ Items[{Slot:14b}].tag.display.Lore append value '{"text":"Click to add soup","color":"dark_gray","underlined":true}'
  execute if score timmyHead MenuFeed matches 7 run data modify block ~ ~ ~ Items[{Slot:14b}].tag.display.Lore append value '{"text":"Click to remove soup","color":"dark_gray","underlined":true}'
  execute if score timmyHead MenuFeed matches 8 run data modify block ~ ~ ~ Items[{Slot:14b}].tag.display.Lore append value '{"text":"Click to add both","color":"dark_gray","underlined":true}'
  ...
  # Status Effects Lore
  execute if score fatigued TimmyStatus matches 1 run data modify block ~ ~ ~ Items[{Slot:14b}].tag.display.Lore append value '{"text":"Fatigued","color":"gold"}'
  execute if score soupLevel TimmyStatus matches 1 run data modify block ~ ~ ~ Items[{Slot:14b}].tag.display.Lore append value '{"text":"Hungry","color":"gold"}'
  execute if score soupLevel TimmyStatus matches 2 run data modify block ~ ~ ~ Items[{Slot:14b}].tag.display.Lore append value '{"text":"Starvation","color":"gold"}'
  execute if score injuredLevel TimmyStatus matches 1 run data modify block ~ ~ ~ Items[{Slot:14b}].tag.display.Lore append value '{"text":"Hurt","color":"gold"}'
  execute if score injuredLevel TimmyStatus matches 2 run data modify block ~ ~ ~ Items[{Slot:14b}].tag.display.Lore append value '{"text":"Agony","color":"gold"}'
  execute if score crazy TimmyStatus matches 1 run data modify block ~ ~ ~ Items[{Slot:14b}].tag.display.Lore append value '{"text":"Crazy","color":"gold"}'
  execute if score sick TimmyStatus matches 1 run data modify block ~ ~ ~ Items[{Slot:14b}].tag.display.Lore append value '{"text":"Sick","color":"gold"}'
  execute if score waterLevel TimmyStatus matches 1 run data modify block ~ ~ ~ Items[{Slot:14b}].tag.display.Lore append value '{"text":"Thirsty","color":"gold"}'
  execute if score waterLevel TimmyStatus matches 2 run data modify block ~ ~ ~ Items[{Slot:14b}].tag.display.Lore append value '{"text":"Dehydration","color":"gold"}'
  execute if score tired TimmyStatus matches 1.. run data modify block ~ ~ ~ Items[{Slot:14b}].tag.display.Lore append value '{"text":"Tired","color":"gold"}'
...
# Soup
  ...
  execute if score timmyGiveSoup MenuFeed matches 1 run data modify block ~ ~ ~ Items insert 0 value {Slot:15b,id:"minecraft:saddle",Count:1b,tag:{CustomModelData:16,isMenu:1b,page:1,selection:32,display:{Name:'{"text":"Give soup","color":"gray","bold":true}',Lore:['{"text":"Click to remove","color":"dark_gray","underlined":true}']}}}
  # Lock
...
# Medkit
  ...
  execute if score medkit ItemsBunker matches ..0 if score sick TimmyStatus matches 1 run data modify block ~ ~ ~ Items insert 0 value {Slot:17b,id:"minecraft:saddle",Count:1b,tag:{CustomModelData:99,isMenu:1b,page:1,selection:0,display:{Name:'{"text":"Locked","color":"red","bold":true}',Lore:['{"text":"Requires medkit","color":"dark_red"}']}}}