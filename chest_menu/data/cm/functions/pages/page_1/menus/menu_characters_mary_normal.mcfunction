...
# Multi Soup And Water
  ...
  execute if score maryMultiAction MenuFeed matches 1 run data modify block ~ ~ ~ Items[{Slot:5b}].tag.display.Lore append value '{"text":"Click to add both","color":"dark_gray","underlined":true}'
  execute if score maryMultiAction MenuFeed matches 2 run data modify block ~ ~ ~ Items[{Slot:5b}].tag.display.Lore append value '{"text":"Click to add soup","color":"dark_gray","underlined":true}'
  execute if score maryMultiAction MenuFeed matches 3 run data modify block ~ ~ ~ Items[{Slot:5b}].tag.display.Lore append value '{"text":"Click to add water","color":"dark_gray","underlined":true}'
  execute if score maryMultiAction MenuFeed matches 4 run data modify block ~ ~ ~ Items[{Slot:5b}].tag.display.Lore append value '{"text":"Click to remove both","color":"dark_gray","underlined":true}'
# Soup
  # Toggle
