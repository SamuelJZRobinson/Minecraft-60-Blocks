...
execute if score selection MenuMain matches 11 if score isMutant MaryStatus matches 0 run function cm:pages/1_feed/actions/action_characters_mary_normal
execute if score selection MenuMain matches 11 if score isMutant MaryStatus matches 1 run function cm:pages/1_feed/actions/action_characters_mary_mutant
# Soup
