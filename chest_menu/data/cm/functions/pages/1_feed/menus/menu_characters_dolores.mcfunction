# Set Head
data modify block ~ ~ ~ Items insert 0 value {Slot:0b,id:"minecraft:saddle",count:1,components:{"minecraft:custom_name":'{"color":"gray","bold":true,"text":"Dolores"}',"minecraft:custom_model_data":7,"minecraft:custom_data":{isMenu:1b,page:1,selection:4}}}
...
# Multi Soup And Water
  ...
  # Multi Lore
  execute if score doloresMultiAction MenuFeed matches -1 run data modify block ~ ~ ~ Items[{Slot:0b}].components.minecraft:lore append value '{"text":"Need more supplies","color":"dark_red"}'
  execute if score doloresMultiAction MenuFeed matches 1 run data modify block ~ ~ ~ Items[{Slot:0b}].components.minecraft:lore append value '{"text":"Add soup and water","color":"dark_gray"}'
  execute if score doloresMultiAction MenuFeed matches 2 run data modify block ~ ~ ~ Items[{Slot:0b}].components.minecraft:lore append value '{"text":"Add soup","color":"dark_gray"}'
  execute if score doloresMultiAction MenuFeed matches 3 run data modify block ~ ~ ~ Items[{Slot:0b}].components.minecraft:lore append value '{"text":"Add water","color":"dark_gray"}'
  execute if score doloresMultiAction MenuFeed matches 4 run data modify block ~ ~ ~ Items[{Slot:0b}].components.minecraft:lore append value '{"text":"Remove soup and water","color":"dark_gray"}'
# Soup
  # Toggle
...
# Status Lore
  # Fatigued
  execute if score isFatigued DoloresStatus matches 1 run data modify block ~ ~ ~ Items[{Slot:0b}].components.minecraft:lore append value '{"text":"Fatigued","color":"gold"}'
  # Soup
  execute if score soup DoloresStatus > HUNGER_AMOUNT_CRITICAL CharactersLevels if score soup DoloresStatus <= HUNGER_AMOUNT_DANGER CharactersLevels run data modify block ~ ~ ~ Items[{Slot:0b}].components.minecraft:lore append value '{"text":"Hungry","color":"gold"}'
  execute if score soup DoloresStatus <= HUNGER_AMOUNT_CRITICAL CharactersLevels run data modify block ~ ~ ~ Items[{Slot:0b}].components.minecraft:lore append value '{"text":"Starvation","color":"gold"}'
  # Injured
  execute if score isInjured DoloresStatus matches 1 if score injuredDays DoloresStatus < INJURED_DAYS_DANGER CharactersLevels run data modify block ~ ~ ~ Items[{Slot:0b}].components.minecraft:lore append value '{"text":"Hurt","color":"gold"}'
  execute if score isInjured DoloresStatus matches 1 if score injuredDays DoloresStatus >= INJURED_DAYS_DANGER CharactersLevels run data modify block ~ ~ ~ Items[{Slot:0b}].components.minecraft:lore append value '{"text":"Agony","color":"gold"}'
  # Crazy
  execute if score isCrazy DoloresStatus matches 1 run data modify block ~ ~ ~ Items[{Slot:0b}].components.minecraft:lore append value '{"text":"Crazy","color":"gold"}'
  # Sick
  execute if score isSick DoloresStatus matches 1 run data modify block ~ ~ ~ Items[{Slot:0b}].components.minecraft:lore append value '{"text":"Sick","color":"gold"}'
  # Water
  execute if score water DoloresStatus > THIRST_AMOUNT_CRITICAL CharactersLevels if score water DoloresStatus <= THIRST_AMOUNT_DANGER CharactersLevels run data modify block ~ ~ ~ Items[{Slot:0b}].components.minecraft:lore append value '{"text":"Thirsty","color":"gold"}'
  execute if score water DoloresStatus <= THIRST_AMOUNT_CRITICAL CharactersLevels run data modify block ~ ~ ~ Items[{Slot:0b}].components.minecraft:lore append value '{"text":"Dehydration","color":"gold"}'
  # Tired
  execute if score isTired DoloresStatus matches 1.. run data modify block ~ ~ ~ Items[{Slot:0b}].components.minecraft:lore append value '{"text":"Tired","color":"gold"}'