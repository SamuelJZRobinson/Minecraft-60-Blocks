# Set Head
data modify block ~ ~ ~ Items insert 0 value {Slot:9b,id:"minecraft:saddle",count:1,components:{"minecraft:custom_name":'{"color":"gray","bold":true,"text":"Mary"}',"minecraft:custom_model_data":12,"minecraft:custom_data":{isMenu:1b,page:1,selection:11}}}
...
# Multi Soup And Water
  ...
  execute if score maryMultiAction MenuFeed matches 1 run data modify block ~ ~ ~ Items[{Slot:9b}].components.minecraft:lore append value '{"text":"Add soup and water","color":"dark_gray"}'
  execute if score maryMultiAction MenuFeed matches 2 run data modify block ~ ~ ~ Items[{Slot:9b}].components.minecraft:lore append value '{"text":"Add soup","color":"dark_gray"}'
  execute if score maryMultiAction MenuFeed matches 3 run data modify block ~ ~ ~ Items[{Slot:9b}].components.minecraft:lore append value '{"text":"Add water","color":"dark_gray"}'
  execute if score maryMultiAction MenuFeed matches 4 run data modify block ~ ~ ~ Items[{Slot:9b}].components.minecraft:lore append value '{"text":"Remove soup and water","color":"dark_gray"}'
# Soup
  # Toggle
...
# Status Lore
  # Fatigued
  execute if score isFatigued MaryStatus matches 1 run data modify block ~ ~ ~ Items[{Slot:9b}].components.minecraft:lore append value '{"text":"Fatigued","color":"gold"}'
  # Soup
  execute if score soup MaryStatus > HUNGER_AMOUNT_CRITICAL CharactersLevels if score soup MaryStatus <= HUNGER_AMOUNT_DANGER CharactersLevels run data modify block ~ ~ ~ Items[{Slot:9b}].components.minecraft:lore append value '{"text":"Hungry","color":"gold"}'
  execute if score soup MaryStatus <= HUNGER_AMOUNT_CRITICAL CharactersLevels run data modify block ~ ~ ~ Items[{Slot:9b}].components.minecraft:lore append value '{"text":"Starvation","color":"gold"}'
  # Injured
  execute if score isInjured MaryStatus matches 1 if score injuredDays MaryStatus < INJURED_DAYS_DANGER CharactersLevels run data modify block ~ ~ ~ Items[{Slot:9b}].components.minecraft:lore append value '{"text":"Hurt","color":"gold"}'
  execute if score isInjured MaryStatus matches 1 if score injuredDays MaryStatus >= INJURED_DAYS_DANGER CharactersLevels run data modify block ~ ~ ~ Items[{Slot:9b}].components.minecraft:lore append value '{"text":"Agony","color":"gold"}'
  # Crazy
  execute if score isCrazy MaryStatus matches 1 run data modify block ~ ~ ~ Items[{Slot:9b}].components.minecraft:lore append value '{"text":"Crazy","color":"gold"}'
  # Sick
  execute if score isSick MaryStatus matches 1 run data modify block ~ ~ ~ Items[{Slot:9b}].components.minecraft:lore append value '{"text":"Sick","color":"gold"}'
  # Water
  execute if score water MaryStatus > THIRST_AMOUNT_CRITICAL CharactersLevels if score water MaryStatus <= THIRST_AMOUNT_DANGER CharactersLevels run data modify block ~ ~ ~ Items[{Slot:9b}].components.minecraft:lore append value '{"text":"Thirsty","color":"gold"}'
  execute if score water MaryStatus <= THIRST_AMOUNT_CRITICAL CharactersLevels run data modify block ~ ~ ~ Items[{Slot:9b}].components.minecraft:lore append value '{"text":"Dehydration","color":"gold"}'
  # Tired
  execute if score isTired MaryStatus matches 1.. run data modify block ~ ~ ~ Items[{Slot:9b}].components.minecraft:lore append value '{"text":"Tired","color":"gold"}'