# Slot 1
  ...
  execute if score itemCount ItemsBunker matches 1.. run function cm:pages/2_expedition/menus/menu_slots_slot_1
...
# Slot 2
  ...
  execute if score itemCount ItemsBunker matches 2.. if score slotOne MenuExpedition matches 2 run function cm:pages/2_expedition/menus/menu_slots_slot_2
...
# Slot 3
  ...
  # Restart Cycle If Items Exist And Suitcase Is Active
  execute if score itemCount ItemsBunker matches 3.. if score slotOne MenuExpedition matches 2 run function cm:pages/2_expedition/menus/menu_slots_slot_3
...
# Slot 4
  ...
  # Restart Cycle If Items Exist And Suitcase Is Active
  execute if score itemCount ItemsBunker matches 4.. if score slotOne MenuExpedition matches 2 run function cm:pages/2_expedition/menus/menu_slots_slot_4