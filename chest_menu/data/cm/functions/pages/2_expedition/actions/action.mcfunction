...
# Character Toggle
function cm:pages/2_expedition/actions/action_characters

# Map Choice
function cm:pages/2_expedition/actions/action_maps

# Increment Slots
function cm:pages/2_expedition/actions/action_slots

# Prepare Expedition Toggle
function cm:pages/2_expedition/actions/action_prepare_expedition
