...
execute if score expeditionPrepared ChestMenuExplore matches 1 if score characterSent ChestMenuExplore matches 0 run function cm:menu/page2/items_expedition
...
# Icons
  ...
  execute if score padlock ItemsBunker matches 1 run function cm:menu/page2/update_padlock_protection
